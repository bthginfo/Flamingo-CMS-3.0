...
const pages = [
  {
    ...
    sections: [
      ...
      { type: 'beforeAfter', data: { headline: 'Veränderung darf weich aussehen.', subline: 'Keine harten Vorher-Nachher-Versprechen, sondern nachvollziehbare Entwicklung.', items: [
        { title: 'Weicher Blondverlauf', text: 'Ansatz beruhigt, Längen veredelt, Pflegeplan angepasst.', beforeImage: img('1549236177-73dba1d2efbf'), afterImage: img('1516975080664-ed2fc6a32937'), category: 'Farbe' },
