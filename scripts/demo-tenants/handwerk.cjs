...
const darkSectionTokens = {
  ...
  // Opaque equivalent of 6% white over C.brand. This keeps contrast audits
  // deterministic while preserving the same visual glass-card surface.
  '--token-card-bg':         '#2F3C46',
      ...
      sections: [
        {
          ...
          data: {
            ...
            primaryCta: { label: 'Leistung einschätzen lassen', href: '/kontakt' },
      ...
      sections: [
        {
          ...
          data: {
            ...
            primaryCta: { label: 'Vorhaben besprechen', href: '/kontakt' },
        ...
        },
        {
          ...
          data: {
            ...
            members: [
              ...
              { name: 'Heinz Brüggemann', role: 'Gründer / Senior-Berater',           image: img('1472099645785-5658abf4ff4e', 600), bio: 'Gründete den Betrieb 1974. Heute in jedem Bad-Erstgespräch dabei — die Erfahrung von fünf Jahrzehnten.' },
              { name: 'Marek Possiwan',   role: 'Technischer Leiter / Meister',        image: img('1531427186611-ecfd6d936c79', 600), bio: 'Verantwortet Wärmepumpen und Großprojekte. Eigene Kältekreis-Zertifizierung.' },
              { name: 'Sophie Reinartz',  role: 'Büroleitung / Förder-Spezialistin',   image: img('1564564295391-7f24f26f568b', 600), bio: 'Kennt BEG- und KfW-Richtlinien auswendig und wickelt jährlich über 70 Anträge ab.' },
            ],
        ...
        },
        {
          ...
          data: {
            ...
            ctaPrimary: { label: 'Kennenlernen vereinbaren', href: '/kontakt', icon: 'CalendarCheck' },
          },
          styleOverrides: { '--token-section-bg': C.brand, ...darkSectionTokens },
        },
      ],
      ...
      sections: [
        {
          ...
          data: {
            ...
            align: 'left',
            primaryCta: { label: 'Eigenes Projekt starten', href: '/kontakt' },
      ...
      sections: [
        {
          ...
          data: {
            ...
            primaryCta: { label: 'Anfrage vorbereiten', href: '/kontakt' },
