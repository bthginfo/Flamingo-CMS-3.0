...
const tenant = {
  ...
  pages: [
    ...
    },
    {
      ...
      title: 'Services',
      sections: [
        section('collectionHero', { headline: 'Service, der Wein einfacher macht.', subline: 'Beratung, Geschenkboxen und Firmenpakete - alles so geplant, dass Auswahl nicht zur Aufgabe wird.', bgImage: img('1556761175-5973dc0f32e7'), backgroundImage: img('1556761175-5973dc0f32e7'), overlayColor: '#160A0F', overlayOpacity: 0.6 }, heroTokens),
        ...
        section('ctaBand', { badgeText: 'Services', headline: 'Wenn der Shop nicht alles beantworten soll.', subline: 'Schreiben Sie uns kurz, worum es geht. Wir melden uns mit einer konkreten Empfehlung.', ctaPrimary: { label: 'Service anfragen', href: '/kontakt', icon: 'Send' } }, ctaTokens),
      ],
    },
    {
      slug: 'beratung',
      title: 'Beratung',
      sections: [
        section('collectionHero', { headline: 'Weinberatung ohne Vortrag.', subline: 'Sie brauchen keine Fachbegriffe. Anlass, Essen, Budget und Stimmung reichen.', bgImage: img('1556761175-5973dc0f32e7'), backgroundImage: img('1556761175-5973dc0f32e7'), overlayColor: '#160A0F', overlayOpacity: 0.6 }, heroTokens),
        ...
        section('ctaBand', { badgeText: 'Beratung starten', headline: 'Schreiben Sie uns, was geplant ist.', subline: 'Wir antworten konkret und ohne Verkaufsdruck.', ctaPrimary: { label: 'Nachricht senden', href: '/kontakt', icon: 'Send' } }, ctaTokens),
    ...
    },
    {
      ...
      title: 'Über uns',
      sections: [
        section('collectionHero', { headline: 'Eine Vinothek, die online nicht anonym wird.', subline: 'Goldberg steht für kleine Auswahl, klare Sprache und Flaschen, die wir selbst öffnen würden.', bgImage: img('1528823872057-9c018a7a7553'), backgroundImage: img('1528823872057-9c018a7a7553'), overlayColor: '#160A0F', overlayOpacity: 0.6 }, heroTokens),
        ...
        section('ctaBand', { badgeText: 'Shop besuchen', headline: 'Genug über uns. Es geht um Ihren Abend.', subline: 'Stöbern Sie durch die Kategorien oder fragen Sie direkt nach einer Empfehlung.', ctaPrimary: { label: 'Weine entdecken', href: '/shop', icon: 'ShoppingBag' } }, ctaTokens),
      ],
    },
    {
      slug: 'versand',
      title: 'Versand',
      sections: [
        section('collectionHero', { headline: 'Wein muss heil ankommen.', subline: 'Darum behandeln wir Versand nicht als Nachsatz.', bgImage: img('1510812431401-41d2bd2722f3'), backgroundImage: img('1510812431401-41d2bd2722f3'), overlayColor: '#160A0F', overlayOpacity: 0.62 }, heroTokens),
