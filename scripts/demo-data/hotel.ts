  ...
  collections: [
    ...
    },
    {
      key: 'rooms', label: 'Zimmer & Suiten', items: [
        { slug: 'komfort-doppelzimmer', title: 'Komfort Doppelzimmer', priority: 0, data: { excerpt: 'Gemütlicher alpiner Charme mit Massivholzmöbeln und Talblick.', description: 'Unser Komfort Doppelzimmer verbindet traditionelle Tiroler Gemütlichkeit mit modernem Komfort. Massivholzmöbel aus heimischer Zirbe, kuschelige Tiroler Wolldecken und ein privater Balkon mit Talblick schaffen eine Atmosphäre zum Durchatmen.', features: ['28 m²', 'Talblick', 'Balkon', 'Regendusche', 'WLAN', 'Zirbenholzmöbel', 'Safe', 'Flatscreen-TV'], image: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=900&q=80', 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=900&q=80'], content: '<p>Eintauchen in die Tiroler Bergwelt – das gelingt nirgends besser als in unserem Komfort Doppelzimmer. Hier trifft alpiner Charme auf zeitgemäßen Komfort: Massivholzmöbel aus heimischer Zirbe, ein kuschelig warmes Lichtkonzept und ein privater Balkon, von dem Sie das Tal überblicken.</p><h3>Ausstattung</h3><p>Das Bad überzeugt mit einer großzügigen Regendusche, flauschigen Bademänteln und hochwertigen Naturkosmetik-Produkten aus der Region. Auf dem Zimmer erwarten Sie ein Flatscreen-TV, schnelles WLAN, ein Safe und eine liebevoll bestückte Minibar.</p><p>Das Frühstücksbuffet (im Preis inbegriffen) bietet regionale Spezialitäten, frisches Gebäck aus der hauseigenen Backstube und eine Live-Eierspeisen-Station.</p>', price: 'ab 189€ / Nacht', cta: { label: 'Zimmer buchen', href: '/kontakt' } } },
        { slug: 'deluxe-doppelzimmer', title: 'Deluxe Doppelzimmer', priority: 1, data: { excerpt: 'Panoramabalkon, Regendusche und hochwertigste Naturmaterialien.', description: 'Das Deluxe Doppelzimmer bietet großzügigen Raum mit Panoramabalkon und Blick auf die Bergkette. Hochwertige Naturmaterialien, eine XXL-Regendusche und eine liebevoll bestückte Minibar machen den Aufenthalt perfekt.', features: ['35 m²', 'Bergpanorama', 'Panoramabalkon', 'XXL-Regendusche', 'Minibar', 'Bademantel & Slippers', 'Nespresso-Maschine', 'Handtuchheizung'], image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=900&q=80'], content: '<p>Großzügig, lichtdurchflutet und mit einem Blick, der den Atem stocken lässt: Das Deluxe Doppelzimmer ist unsere Empfehlung für Paare, die sich etwas Besonderes gönnen möchten.</p><h3>Das Highlight</h3><p>Der breite Panoramabalkon mit bequemen Liegestühlen wird zu Ihrem privaten Aussichtspunkt – morgens zum Sonnenaufgang, abends zum Alpenglühen. Die XXL-Regendusche mit Bergblick und die Nespresso-Maschine auf dem Zimmer runden das Wohlfühlerlebnis ab.</p><p>Alle Deluxe-Zimmer liegen auf der Südseite des Hotels und bieten freie Sicht auf die Bergkette. Inklusive: Frühstücksbuffet, Spa-Nutzung und Parkplatz.</p>', price: 'ab 259€ / Nacht', cta: { label: 'Zimmer buchen', href: '/kontakt' } } },
        { slug: 'junior-suite', title: 'Junior Suite', priority: 2, data: { excerpt: 'Großzügige Suite mit Sitzecke, Badewanne & Regendusche.', description: 'Die Junior Suite bietet Ihnen ein großzügiges Raumkonzept mit separater Sitzecke, einer freistehenden Badewanne UND einer Regendusche. Perfekt für Paare, die etwas mehr Platz und Luxus wünschen.', features: ['48 m²', 'Bergpanorama', 'Separate Sitzecke', 'Freistehende Badewanne', 'Regendusche', 'Nespresso', 'Bademäntel', 'Kamin'], image: 'https://images.unsplash.com/photo-1591088398332-8a7791972843?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1591088398332-8a7791972843?w=900&q=80'], content: '<p>Mehr Platz, mehr Luxus, mehr Auszeit: Die Junior Suite bietet auf 48 m² alles, was das Herz begehrt. Die separate Sitzecke mit Kamin wird am Abend zum gemütlichen Rückzugsort, während die freistehende Badewanne mit Bergblick für unvergessliche Momente sorgt.</p><h3>Perfekt für besondere Anlässe</h3><p>Ob Honeymoon, Geburtstag oder einfach eine wohlverdiente Pause: Wir dekorieren Ihre Suite auf Wunsch mit Blumen und einer Flasche regionalen Sekt. Fragen Sie unser Concierge-Team nach unseren Romance-Paketen.</p><p>Inklusive: Erweitertes Frühstück auf dem Zimmer (auf Wunsch), Spa-Nutzung, private Tiefgarage und Late Check-out bis 14 Uhr (nach Verfügbarkeit).</p>', price: 'ab 349€ / Nacht', cta: { label: 'Suite reservieren', href: '/kontakt' } } },
        { slug: 'penthouse-suite', title: 'Penthouse Suite', priority: 3, data: { excerpt: 'Privater Whirlpool auf der Dachterrasse, Kamin und Butler-Service.', description: 'Unser Kronjuwel: Die Penthouse Suite erstreckt sich über 120 m² auf zwei Ebenen. Privater Whirlpool auf der Dachterrasse, offener Kamin, Butler-Service und ein Blick, der seinesgleichen sucht — das ultimative alpine Luxuserlebnis.', features: ['120 m²', '2 Ebenen', 'Privater Whirlpool', 'Dachterrasse', 'Offener Kamin', 'Butler-Service', 'Begehbarer Kleiderschrank', 'Bang & Olufsen Sound'], image: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1590490360182-c33d57733427?w=900&q=80', 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=900&q=80'], content: '<p>Die Penthouse Suite ist unser Meisterstück – und ein Erlebnis, das Sie so schnell nicht vergessen werden. Auf 120 m² und zwei Ebenen erwartet Sie alpiner Luxus in seiner schönsten Form.</p><h3>Untere Ebene</h3><p>Großzügiger Wohnbereich mit offenem Kamin, begehbarem Kleiderschrank, Marmorbad mit Doppelwaschtisch und freistehender Wanne. Bang & Olufsen Entertainment-System und eine handverlesene Minibar mit regionalen Spezialitäten.</p><h3>Obere Ebene</h3><p>Ihre private Dachterrasse mit beheizbarem Whirlpool, Outdoor-Lounge und 360°-Alpenpanorama. Hier erleben Sie Sonnenauf- und -untergänge, die Sie nie vergessen werden.</p><p>Inklusive: Butler-Service, Frühstück auf dem Zimmer, private Spa-Stunde, Flughafentransfer und Concierge-Service.</p>', price: 'ab 890€ / Nacht', cta: { label: 'Penthouse anfragen', href: '/kontakt' } } },
        { slug: 'panorama-suite', title: 'Panorama Suite', priority: 4, data: { excerpt: 'Großzügige Suite mit separatem Wohnbereich und 180°-Alpenpanorama.', description: 'Die Panorama Suite bietet separate Schlaf- und Wohnbereiche, eine freistehende Badewanne mit Bergblick und einen großzügigen Balkon mit 180°-Alpenpanorama. Hochwertige Materialien und durchdachtes Design schaffen eine Oase der Ruhe.', features: ['72 m²', '180° Panorama', 'Freistehende Badewanne', 'Separater Wohnbereich', 'Großer Balkon', 'Nespresso', 'Bademäntel & Slippers', 'Schreibtisch'], image: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=900&q=80'], content: '<p>Aufwachen mit Alpenpanorama – in der Panorama Suite wird dieser Traum Realität. Die bodentiefen Fenster rahmen die Bergkette wie ein lebendes Gemälde. Der separate Wohnbereich bietet Raum zum Lesen, Arbeiten oder einfach Staunen.</p><h3>Für Genießer</h3><p>Die freistehende Badewanne ist strategisch platziert: mit direktem Blick auf die Berge. Abends lassen Sie bei einem Glas Wein auf dem Balkon die Alpen im Abendrot leuchten.</p><p>Die Panorama Suite eignet sich perfekt für längere Aufenthalte – der Schreibtisch mit Bergblick macht auch Remote Work zum Urlaub. Inklusive: Frühstücksbuffet, Spa, Parkplatz.</p>', price: 'ab 449€ / Nacht', cta: { label: 'Suite buchen', href: '/kontakt' } } },
        { slug: 'familien-suite', title: 'Familien Suite', priority: 5, data: { excerpt: 'Zwei verbundene Zimmer, zwei Bäder — perfekt für die Familie.', description: 'Die Familien Suite besteht aus zwei verbundenen Zimmern mit jeweils eigenem Bad. Kinderbetten, eine gemütliche Spielecke und kindersichere Ausstattung machen den Familienurlaub sorgenfrei.', features: ['65 m²', '2 Schlafzimmer', '2 Bäder', 'Kinderbetten', 'Spielecke', 'Kindersichere Ausstattung', 'Flatscreen-TV', 'Balkon'], image: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=900&q=80', gallery: ['https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=900&q=80'], content: '<p>Familienurlaub ohne Kompromisse: In unserer Familien Suite haben alle ihren Platz. Zwei verbundene Zimmer – eins für die Eltern, eins für die Kinder – sorgen dafür, dass abends jeder zur Ruhe kommt.</p><h3>Für die Kleinen</h3><p>Das Kinderzimmer ist mit altersgerechten Betten, einer gemütlichen Spielecke und kindersicheren Steckdosen ausgestattet. Auf Wunsch stellen wir Babybetten, Wickelauflage und Flaschenwärmer bereit – alles kostenfrei.</p><h3>Für die Großen</h3><p>Das Elternschlafzimmer bietet King-Size-Bett, Balkon und ein eigenes Bad mit Regendusche. Abends, wenn die Kinder schlafen, genießen Sie die Ruhe oder einen Film auf dem Smart-TV.</p><p>Unser Kids-Club (3-12 Jahre) betreut Ihre Kinder täglich von 9-17 Uhr – damit Sie auch mal zu zweit die Berge oder den Spa genießen können.</p>', price: 'ab 389€ / Nacht', cta: { label: 'Familienzimmer buchen', href: '/kontakt' } } },
      ],
    },
  ],
};
