/**
 * Rich demo seed: Consulting (Kanzlei Bergmann & Partner)
 * Section types: hero, practiceAreas, caseResults, team, testimonials, ctaBand, logoMarquee,
 * faq, feeTable, textImage, processSteps, richText, publications, socialProofBar, contact, statsCounter
 */
export const CONSULTING_CONFIG = {
  ...
  activeStyle: 'classic',
  brand: {
    companyName: 'Kanzlei Bergmann & Partner',
    tagline: 'Recht. Klarheit. Lösungen. — Kompetente Rechtsberatung in Berlin seit 2004.',
    primaryColor: '#1a2744',
    secondaryColor: '#2c4a7c',
    accentColor: '#b8860b',
  },
  contact: { phone: '+49 30 2589 4400', email: 'kanzlei@bergmann-partner.de', address: 'Friedrichstraße 78, 10117 Berlin' },
  socialLinks: { linkedin: 'https://linkedin.com/company/bergmann-partner', xing: 'https://xing.com/companies/bergmannpartner' },
  navItems: [
    { label: 'Startseite', href: '/', type: 'link' },
    { label: 'Rechtsgebiete', href: '/rechtsgebiete', type: 'link' },
    { label: 'Team', href: '/team', type: 'link' },
    { label: 'Über uns', href: '/ueber-uns', type: 'link' },
    { label: 'Aktuelles', href: '/aktuelles', type: 'link' },
    { label: 'Kontakt', href: '/kontakt', type: 'link' },
  ],
  navCta: { label: 'Erstberatung vereinbaren', href: '/kontakt' },
  footerColumns: [
    { title: 'Kanzlei', items: [{ text: 'Rechtsgebiete', href: '/rechtsgebiete' }, { text: 'Team', href: '/team' }, { text: 'Über uns', href: '/ueber-uns' }] },
    { title: 'Service', items: [{ text: 'Aktuelles', href: '/aktuelles' }, { text: 'Erstberatung', href: '/kontakt' }] },
    { title: 'Kontakt', items: [{ text: '+49 30 2589 4400' }, { text: 'kanzlei@bergmann-partner.de' }, { text: 'Friedrichstraße 78, 10117 Berlin' }] },
  ],
  ...
  pages: [
    /* ─── Startseite ─── */
    {
      slug: 'startseite', title: 'Startseite', sections: [
        { type: 'hero', sortOrder: 0, data: {
          ...
          primaryCta: { label: 'Erstberatung vereinbaren', href: '/kontakt' },
          secondaryCta: { label: 'Rechtsgebiete ansehen', href: '/rechtsgebiete' },
        }},
        { type: 'practiceAreas', sortOrder: 1, data: {
          headline: 'Unsere Rechtsgebiete',
          subline: 'Fundierte Beratung in den Bereichen, die für Sie zählen.',
          badgeText: 'Kompetenzen',
          areas: [
            { title: 'Arbeitsrecht', text: 'Kündigungsschutz, Abfindungen, Aufhebungsverträge und Betriebsratsberatung.', icon: 'briefcase', href: '/rechtsgebiete' },
            { title: 'Familienrecht', text: 'Scheidung, Unterhalt, Sorgerecht und Vermögensaufteilung.', icon: 'heart', href: '/rechtsgebiete' },
            { title: 'Miet- & Immobilienrecht', text: 'Mietverträge, Räumungsklagen, Eigenbedarf und Gewerbemiete.', icon: 'home', href: '/rechtsgebiete' },
            { title: 'Handels- & Gesellschaftsrecht', text: 'Firmengründung, Vertragsgestaltung, M&A und Gesellschafterstreitigkeiten.', icon: 'building-2', href: '/rechtsgebiete' },
            { title: 'Strafrecht', text: 'Verteidigung in Ermittlungsverfahren, Wirtschaftsstrafrecht, Revision.', icon: 'shield', href: '/rechtsgebiete' },
            { title: 'Erbrecht', text: 'Testamentsgestaltung, Erbstreitigkeiten und Nachlassverwaltung.', icon: 'scroll-text', href: '/rechtsgebiete' },
          ],
        }},
        { type: 'caseResults', sortOrder: 2, data: {
        ...
        { type: 'ctaBand', sortOrder: 5, data: {
          ...
          ctaPrimary: { label: 'Erstberatung vereinbaren', href: '/kontakt' },
        }},
        { type: 'logoMarquee', sortOrder: 6, data: {
    ...
    /* ─── Rechtsgebiete ─── */
    {
      slug: 'rechtsgebiete', title: 'Rechtsgebiete', sections: [
        { type: 'hero', sortOrder: 0, data: {
        ...
        { type: 'feeTable', sortOrder: 2, data: {
    ...
    /* ─── Über uns ─── */
    {
      slug: 'ueber-uns', title: 'Über uns', sections: [
        ...
        { type: 'caseResults', sortOrder: 3, data: {
        ...
        { type: 'richText', sortOrder: 4, data: {
    ...
    /* ─── Aktuelles ─── */
    {
      slug: 'aktuelles', title: 'Aktuelles', sections: [
        { type: 'hero', sortOrder: 0, data: {
        ...
        { type: 'publications', sortOrder: 1, data: {
        ...
        { type: 'ctaBand', sortOrder: 3, data: {
          ...
          ctaPrimary: { label: 'Erstberatung buchen', href: '/kontakt' },
        }},
        { type: 'socialProofBar', sortOrder: 4, data: {
          items: [
