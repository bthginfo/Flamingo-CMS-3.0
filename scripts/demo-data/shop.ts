...
export const SHOP_CONFIG = {
  ...
  shopProducts: [
    ...
    { title: 'Grüner Veltliner Bio 2022', slug: 'gruener-veltliner-bio-2022', category: 'bio-weine', priceCents: 1490, comparePriceCents: null, description: 'Biodynamisch angebaut im Kamptal. Pfeffrig, frisch mit Noten von weißem Pfeffer und Grapefruit.', shortDescription: 'Bio, Kamptal, Österreich', images: ['https://images.unsplash.com/photo-1560493676-04071c5f467b?w=600&q=80'], stock: 30, status: 'active' },
    { title: 'Chianti Classico Bio 2020', slug: 'chianti-classico-bio-2020', category: 'bio-weine', priceCents: 1790, comparePriceCents: 2190, description: 'Biologischer Anbau in der Toskana. Kirscharomen, Gewürze und feinkörnige Tannine mit langem Abgang.', shortDescription: 'Bio DOCG, Toskana', images: ['https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=600&q=80'], stock: 18, status: 'active' },
    { title: 'Rioja Reserva 2017', slug: 'rioja-reserva-2017', category: 'rotwein', priceCents: 2490, comparePriceCents: null, description: 'Eleganter Tempranillo aus dem Rioja mit Vanille, Leder und reifen Beerenfrüchten. 18 Monate Barrique-Ausbau.', shortDescription: 'DOCa Rioja, Spanien', images: ['https://images.unsplash.com/photo-1584916201218-f4242ceb4809?w=600&q=80'], stock: 20, status: 'active' },
  ],
};
