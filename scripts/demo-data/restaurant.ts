  ...
  collections: [
    {
      key: 'speisekarte', label: 'Speisekarte', items: [
        { slug: 'antipasti', title: 'Antipasti & Vorspeisen', priority: 0, data: { description: 'Italienische Vorspeisen aus frischen, saisonalen Zutaten — von Vitello Tonnato bis Burrata mit San-Marzano-Tomaten.', features: ['Vitello Tonnato', 'Burrata con Pomodori', 'Carpaccio di Manzo', 'Bruschetta Tricolore', 'Insalata Caprese', 'Calamari Fritti'], image: 'https://images.unsplash.com/photo-1550507992-eb63ffee0847?w=900&q=80', content: '<h3>Der perfekte Start</h3><p>Unsere Antipasti sind mehr als nur ein Auftakt — sie sind eine Liebeserklärung an die italienische Küche. Alle Zutaten beziehen wir von ausgewählten Lieferanten: Mozzarella di Bufala aus Kampanien, Prosciutto di San Daniele, Olivenöl aus Ligurien.</p><p>Saisonal ergänzt durch Trüffel, weiße Spargel oder Steinpilze.</p><h3>Unsere Empfehlung</h3><p>Starten Sie mit unserem Antipasti-Teller für 2 — eine Auswahl von 8 kalten und warmen Vorspeisen, frisch angerichtet auf Steinplatte. Dazu ein Glas Prosecco aus dem Veneto.</p>', gallery: ['https://images.unsplash.com/photo-1550507992-eb63ffee0847?w=900&q=80', 'https://images.unsplash.com/photo-1541014741259-de529411b96a?w=900&q=80', 'https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?w=900&q=80'], price: '12–24 €', cta: { label: 'Tisch reservieren', href: '/kontakt' } } },
        { slug: 'pasta-risotto', title: 'Pasta & Risotto', priority: 1, data: { description: 'Handgemachte Pasta frisch aus unserer Küche und cremige Risotti mit saisonalen Zutaten.', features: ['Tagliatelle al Tartufo', 'Spaghetti Vongole', 'Ravioli di Ricotta', 'Risotto ai Funghi Porcini', 'Gnocchi al Pesto', 'Pappardelle al Ragù'], image: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=900&q=80', content: '<h3>Handgemacht, jeden Tag</h3><p>Unsere Pasta wird täglich frisch in der Küche hergestellt. Küchenchef Giovanni verwendet traditionelle Bronze-Matrizen für die perfekte Textur, die Saucen optimal aufnimmt.</p><p>Die Risotti kochen wir ausschließlich mit Carnaroli-Reis und hausgemachter Brodo. Garzeit: 18 Minuten — Perfektion braucht Zeit.</p><h3>Die Kunst der Pasta</h3><p>Jeden Morgen ab 6 Uhr arbeitet unser Pasta-Meister mit Semola di Grano Duro und frischen Eiern von regionalen Höfen. 12 verschiedene Formen — von Tagliatelle über Ravioli bis zu Orecchiette — entstehen in Handarbeit. Die Trocknung erfolgt bei 38°C für 48 Stunden.</p>', gallery: ['https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=900&q=80', 'https://images.unsplash.com/photo-1556761223-4c4282c73f77?w=900&q=80', 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=900&q=80'], price: '18–32 €', cta: { label: 'Tisch reservieren', href: '/kontakt' } } },
        { slug: 'pesce-carne', title: 'Fisch & Fleisch', priority: 2, data: { description: 'Hauptgerichte vom Josper-Grill und aus dem Holzofen — vom Branzino bis zum Bistecca alla Fiorentina.', features: ['Branzino alla Griglia', 'Bistecca alla Fiorentina', 'Ossobuco alla Milanese', 'Tagliata di Manzo', 'Salmone al Forno', 'Agnello al Rosmarino'], image: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=900&q=80', content: '<h3>Feuer & Flamme</h3><p>Unser Josper-Holzkohlegrill aus Barcelona erreicht Temperaturen von über 500°C und verleiht Fleisch und Fisch eine unnachahmliche Rauchnote bei perfekt saftigem Kern.</p><p>Das Bistecca alla Fiorentina (1,2 kg, für 2 Personen) ist unser Signature Dish — dry-aged für 40 Tage vom Chianina-Rind.</p><h3>Herkunft & Qualität</h3><p>Unser Fleisch beziehen wir direkt von ausgewählten Züchtern in der Toskana (Chianina) und dem Piemont (Fassona). Die Fischlieferung kommt 3x wöchentlich direkt vom Großmarkt in Rungis bei Paris — Frische, die man schmeckt.</p>', gallery: ['https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=900&q=80', 'https://images.unsplash.com/photo-1544025162-d76694265947?w=900&q=80', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=900&q=80'], price: '28–85 €', cta: { label: 'Tisch reservieren', href: '/kontakt' } } },
        { slug: 'dolci', title: 'Dolci & Desserts', priority: 3, data: { description: 'Italienische Dessertkunst: Tiramisu nach Originalrezept, Panna Cotta und saisonale Kreationen.', features: ['Tiramisu Classico', 'Panna Cotta', 'Affogato al Caffè', 'Limoncello-Sorbet', 'Cannoli Siciliani', 'Semifreddo'], image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=900&q=80', content: '<h3>Süßer Abschluss</h3><p>Unsere Dolci werden ausnahmslos im Haus hergestellt. Das Tiramisu nach dem Originalrezept von Giovannis Großmutter braucht 24 Stunden Ruhezeit — und schmeckt jede Sekunde davon.</p><p>Saisonal neu: Im Sommer erfrischende Granita, im Winter warmes Tortino al Cioccolato mit flüssigem Kern.</p><h3>Begleitend empfohlen</h3><p>Dazu ein Glas Vin Santo di Carmignano oder einen Espresso aus unserer La-Marzocca-Maschine mit Bohnen der Rösterei Ditta Artigianale aus Florenz. Für den krönenden Abschluss: ein Grappa Riserva von Nonino — 18 Monate im Barriquefass gereift.</p>', gallery: ['https://images.unsplash.com/photo-1551024506-0bccd828d307?w=900&q=80', 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=900&q=80'], price: '10–16 €', cta: { label: 'Tisch reservieren', href: '/kontakt' } } },
      ],
    },
    {
