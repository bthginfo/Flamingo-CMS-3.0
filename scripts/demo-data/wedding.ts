...
export const WEDDING_CONFIG = {
  ...
  collections: [
    {
      key: 'pakete', label: 'Hochzeitspakete', items: [
        { slug: 'paket-intimate', title: 'Intimate — Kleine Hochzeit', priority: 0, data: { description: 'Für Paare, die im engsten Kreis feiern möchten: bis 30 Gäste, persönlich und stilvoll.', features: ['Planung & Koordination', 'Location-Scouting', 'Freie Trauung', 'Floristik (Brautstrauß + Tischdeko)', 'Fotograf (6 Stunden)', 'DJ (4 Stunden)'], image: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=900&q=80', content: '<h3>Klein & Fein</h3><p>Manchmal sind es die intimsten Momente, die am meisten berühren. Unser Intimate-Paket ist für Paare, die im engsten Kreis von Familie und besten Freunden feiern möchten — ohne Kompromisse bei Stil und Qualität.</p><p>Wir kümmern uns um alles: Von der Auswahl der perfekten Micro-Wedding-Location bis zur Koordination am Tag selbst. Ihr genießt, wir organisieren.</p>', price: 'ab 3.900 €', cta: { label: 'Anfrage senden', href: '/kontakt' } } },
        { slug: 'paket-classic', title: 'Classic — Die große Feier', priority: 1, data: { description: 'Das volle Programm für 50–120 Gäste: Planung, Design, Koordination und ein unvergesslicher Tag.', features: ['Fullservice-Planung (6 Monate)', 'Konzept & Moodboard', 'Location + Catering', 'Freie Trauung + Redner', 'Foto + Video (ganzer Tag)', 'Blumen, Deko, Papeterie'], image: 'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=900&q=80', content: '<h3>Euer großer Tag</h3><p>Das Classic-Paket ist unser beliebtestes Angebot: In 6 Monaten intensiver Planung entwickeln wir gemeinsam euer individuelles Hochzeitskonzept — von der Save-the-Date-Karte bis zum Last Dance.</p><p>Im Paket enthalten: persönliches Designkonzept, Auswahl und Buchung aller Dienstleister, Timeline-Erstellung, Gästemanagement und Koordination am Hochzeitstag mit 2 Wedding Plannern vor Ort.</p>', price: 'ab 7.500 €', cta: { label: 'Beratungsgespräch', href: '/kontakt' } } },
        { slug: 'paket-luxury', title: 'Luxury — Premium Hochzeit', priority: 2, data: { description: 'Keine Grenzen, keine Kompromisse: Maßgeschneiderte Luxus-Hochzeiten mit allem, was das Herz begehrt.', features: ['12+ Monate Planung', 'Exklusiv-Locations', 'Premium Catering & Bar', 'Live-Band + DJ', 'Foto + Video + Drohne', 'Hochzeitsreise-Planung'], image: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=900&q=80', content: '<h3>Grenzenlos feiern</h3><p>Das Luxury-Paket ist für Paare, die sich das Beste vom Besten wünschen. Wir realisieren auch außergewöhnliche Wünsche: Hochzeiten in Schlössern, auf Inseln oder in den Bergen — international, ohne Limits.</p><p>Inklusive: Dedicated Wedding Planner als einzige Ansprechperson, unbegrenzte Planungstreffen, VIP-Dienstleister-Portfolio, Gäste-Concierge-Service und After-Wedding-Brunch-Organisation.</p>', price: 'ab 15.000 €', cta: { label: 'VIP-Anfrage', href: '/kontakt' } } },
        { slug: 'paket-destination', title: 'Destination — Auslandshochzeit', priority: 3, data: { description: 'Heiraten in der Toskana, auf Mallorca oder an der Amalfiküste? Wir planen eure Traumhochzeit im Ausland.', features: ['Location-Besichtigung vor Ort', 'Lokale Dienstleister-Koordination', 'Gäste-Reiseplanung', 'Rechtliche Beratung', 'Welcome Dinner', 'Mehrtägiges Programm'], image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=900&q=80', content: '<h3>Fernweh & Ja-Wort</h3><p>Eine Destination Wedding ist mehr als eine Hochzeit — sie ist ein Erlebnis für alle. Wir planen seit 8 Jahren Hochzeiten im Ausland und kennen die besten Locations, Fotografen und Caterer in Italien, Spanien, Griechenland und Frankreich.</p><p>Unser Rundum-Sorglos-Paket: Wir kümmern uns um die gesamte Logistik — von der Unterkunft für eure Gäste bis zum Transport, von der standesamtlichen Anerkennung bis zum Flughafentransfer.</p>', price: 'ab 12.000 €', cta: { label: 'Destination-Anfrage', href: '/kontakt' } } },
      ],
    },
  ],
};
