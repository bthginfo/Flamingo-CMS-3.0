  ...
  collections: [
    ...
    },
    {
      key: 'services', label: 'Leistungen', items: [
        ...
        { slug: 'vorsorge-checkup', title: 'Vorsorge & Check-up', priority: 4, data: { excerpt: 'Gesundheitscheck ab 35, Hautkrebs-Screening und Impfberatung.', description: 'Prävention ist die beste Medizin. Unsere umfassenden Vorsorgeprogramme erkennen Risiken frühzeitig: Vom Gesundheits-Check-up über Hautkrebs-Screening bis zur individuellen Impfberatung.', features: ['Gesundheits-Check ab 35', 'Hautkrebs-Screening', 'Impfberatung & Impfungen', 'Krebsvorsorge', 'Schilddrüsen-Screening', 'PSA-Test'], image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=900&q=80' } },
