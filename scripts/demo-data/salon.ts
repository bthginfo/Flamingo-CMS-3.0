...
export const SALON_CONFIG = {
  ...
  collections: [
    {
      key: 'services', label: 'Behandlungen', items: [
        { slug: 'damen-haarschnitt', title: 'Damen-Haarschnitt', priority: 0, data: { description: 'Beratung, Waschen, Schneiden und Föhnen — individuell auf Ihren Typ abgestimmt. Inklusive Kopfhautmassage und Styling-Tipps für zuhause.', features: ['Typberatung', 'Waschen & Pflege', 'Präzisionsschnitt', 'Föhnen & Styling', 'Kopfhautmassage', 'Nachschnitt-Garantie'], image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=900&q=80', content: '<h3>Ihr perfekter Schnitt</h3><p>Jeder Haarschnitt beginnt mit einer ausführlichen Beratung. Wir analysieren Ihre Haarstruktur, Gesichtsform und Ihren Lifestyle, um den perfekten Schnitt für Sie zu finden.</p><p>Unsere Stylisten arbeiten mit modernsten Schnitttechniken — ob Calligraphy Cut für mehr Volumen oder Razor Cut für weiche Übergänge.</p>', price: 'ab 65 €', cta: { label: 'Termin buchen', href: '/kontakt' } } },
        { slug: 'balayage-highlights', title: 'Balayage & Highlights', priority: 1, data: { description: 'Natürliche Farbverläufe und sonnengeküsste Highlights — von Hand gemalt für maximale Natürlichkeit.', features: ['Farbberatung', 'Freihand-Balayage', 'Olaplex-Schutz', 'Glossing', 'Pflegekur', 'Styling'], image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=900&q=80', content: '<h3>Natürliche Lichtreflexe</h3><p>Balayage ist die Kunst der freihand-gemalten Highlights. Anders als klassische Foliensträhnen entstehen weiche, natürliche Farbverläufe, die Ihr Haar zum Leuchten bringen.</p><p>Wir verwenden ausschließlich premium Colorationsprodukte mit integriertem Olaplex-Schutz, damit Ihr Haar auch nach der Behandlung gesund bleibt.</p>', price: 'ab 120 €', cta: { label: 'Beratungstermin', href: '/kontakt' } } },
        { slug: 'brautstyling', title: 'Brautstyling', priority: 2, data: { description: 'Das perfekte Styling für Ihren großen Tag: Haare und Make-up aus einer Hand, inklusive Probe-Termin.', features: ['Beratungsgespräch', 'Probe-Styling', 'Hochsteckfrisur', 'Make-up', 'Styling Brautjungfern', 'Anfahrt inklusive'], image: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=900&q=80', content: '<h3>Ihr perfekter Tag</h3><p>Unser Brautstyling-Paket beginnt 3–6 Monate vor der Hochzeit mit einem persönlichen Beratungsgespräch. Beim Probe-Termin testen wir verschiedene Frisuren und Make-up-Looks, bis wir Ihren Traumstil gefunden haben.</p><p>Am Hochzeitstag kommen wir zu Ihnen — stressfrei und entspannt. Auf Wunsch stylen wir auch Brautjungfern und die Brautmutter.</p>', price: 'ab 450 €', cta: { label: 'Anfrage senden', href: '/kontakt' } } },
        { slug: 'herrenhaarschnitt', title: 'Herren-Haarschnitt', priority: 3, data: { description: 'Klassisch oder modern — vom Business-Cut bis zum Fade. Inklusive Waschen, Schnitt und Styling.', features: ['Beratung', 'Waschen', 'Maschinenschnitt oder Schere', 'Konturenschnitt', 'Bart-Trim', 'Styling'], image: 'https://images.unsplash.com/photo-1503951914875-452d3950a8f1?w=900&q=80', content: '<h3>Mehr als nur ein Haarschnitt</h3><p>Unser Herrenbereich verbindet klassisches Barber-Handwerk mit modernem Salon-Komfort. Ob Skin Fade, Pompadour oder klassischer Seitenscheitel — wir beherrschen alle Techniken.</p><p>Jeder Besuch inkludiert eine heiße Handtuch-Behandlung und eine kurze Kopfmassage.</p>', price: 'ab 38 €', cta: { label: 'Termin buchen', href: '/kontakt' } } },
        { slug: 'keratinbehandlung', title: 'Keratin-Glättung', priority: 4, data: { description: 'Frizz-frei und geschmeidig für bis zu 4 Monate. Unsere Brazilian Keratin Treatment glättet und pflegt gleichzeitig.', features: ['Haarstruktur-Analyse', 'Tiefenreinigung', 'Keratin-Aufbau', 'Hitzeversiegelung', 'Pflegeanleitung', 'Nachbehandlung'], image: 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=900&q=80', content: '<h3>Glatt, glänzend, gepflegt</h3><p>Die Keratin-Behandlung füllt poröse Stellen im Haar auf und versiegelt die Oberfläche. Das Ergebnis: geschmeidiges, frizz-freies Haar mit natürlichem Glanz — für bis zu 4 Monate.</p><p>Besonders geeignet für krauses, welliges oder chemisch geschädigtes Haar. Formaldehydfrei und schonend.</p>', price: 'ab 180 €', cta: { label: 'Termin buchen', href: '/kontakt' } } },
      ],
    },
    {
