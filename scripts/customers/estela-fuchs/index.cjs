...
module.exports = flatten({
  ...
  wipe: true,
  brand: {
    companyName: 'Estela Fuchs',
    tagline: 'Praxis für ganzheitliche Psychotherapie',
    primaryColor: '#263042',
    secondaryColor: '#6F6259',
    accentColor: '#A85F45',
    pageBg: '#F5F1EC',
    sectionBg: '#FFFCF8',
    sectionBgAlt: '#EDE5DD',
    cardBg: '#FFFFFF',
    headingColor: '#18202E',
    bodyTextColor: '#394557',
    mutedTextColor: '#687386',
    navBgColor: '#FFFCF8',
    navLinkColor: '#263042',
    navBrandColor: '#18202E',
    footerColor: '#202938',
    footerTextColor: '#E8E2DC',
    footerLinkColor: '#FFFFFF',
    btnPrimaryBg: '#263042',
    btnPrimaryText: '#FFFFFF',
    btnSecondaryBg: '#FFFCF8',
    btnSecondaryText: '#263042',
    btnSecondaryBorder: '#B9B0A8',
    badgeBg: '#EEE1D8',
    badgeText: '#6B3523',
    cardBorder: '#DED6CE',
    borderColor: '#DED6CE',
  ...
  design: {
    ...
    cardShadow: '0 18px 50px rgba(24,32,46,0.09)',
    headingWeight: '750',
  ...
  formFields: [
    ...
    { name: 'subject', label: 'Anliegen', type: 'text', halfWidth: true },
