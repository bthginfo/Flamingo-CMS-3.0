  ...
  return [
    {
      ...
      data: {
        ...
        headline: 'Ich plane Bilder so, dass sie später überall funktionieren.',
        text: '<p>Vor einem Shooting kläre ich, welche Wirkung ein Bild haben soll: für Website, Social, Kampagne, Portraitstrecke oder Präsentation. KI nutze ich dabei als kontrolliertes Werkzeug, um Looks, Varianten und Formate früher sichtbar zu machen.</p><p>Das ersetzt nicht die Fotografie. Es macht Entscheidungen klarer, bevor produziert wird.</p>',
        imagePrimary: assets.heroPortrait,
        imageSecondary: assets.studioWide,
    ...
    },
    {
      ...
      data: {
        badge: 'Entscheidungen',
        headline: 'AI ist bei mir kein Effekt, sondern ein früher Prüfstand.',
        subline: 'Ich nutze den Workflow, um Bildsprache, Zuschnitt und Ausgabe schneller zu beurteilen.',
        statements: [
          { prefix: 'Erst wird die', highlight: 'Wirkung', suffix: 'klar.', text: 'Ich prüfe, was sichtbar werden soll: Haltung, Zielgruppe, Nutzen und Einsatzkanal.', image: assets.businessCampaign },
          { prefix: 'Dann entsteht eine', highlight: 'Bildlinie', suffix: 'statt Zufall.', text: 'Look, Licht, Farbe, Perspektive und Tonalität werden als visuelle Richtung angelegt.', image: assets.personalBranding },
          { prefix: 'Danach wird', highlight: 'real produziert', suffix: '.', text: 'Foto und Film bleiben der Kern. KI hilft bei Planung, Varianten und sauberer Auslieferung.', image: assets.archiveStill02 },
        ],
        cta: { label: 'Ablauf besprechen', href: '/kontakt' },
      },
    },
    {
      ...
      data: {
        badge: 'Ablauf',
        headline: 'Vom Looktest zur fertigen Strecke.',
        intro: 'Der Workflow bleibt bewusst einfach: Wirkung festlegen, Motive planen, produzieren, Formate ableiten.',
        transition: 'crossfade',
        chapters: [
          {
            kicker: '01 · Richtung',
            title: 'Ich kläre, wofür die Bilder arbeiten.',
            text: 'Website, Personal Brand, Kampagne, Social oder Print brauchen unterschiedliche Entscheidungen. Diese Richtung steht vor der Produktion.',
          ...
          {
            kicker: '02 · Look',
            title: 'Ich teste Stimmung, Licht und Zuschnitt.',
            text: 'KI hilft mir, Varianten kontrolliert zu prüfen. Dadurch sieht man früher, welche Bildwelt trägt und welche nicht.',
            image: assets.archiveStill03,
            ctaLabel: 'Look besprechen',
            ctaHref: '/kontakt',
          },
          {
            kicker: '03 · Produktion',
            title: 'Ich fotografiere und filme mit dem finalen Einsatz im Kopf.',
            text: 'Am Set geht es nicht nur um ein gutes Einzelbild. Ich plane Serien, Reels, Details und Formate direkt mit.',
            image: assets.heroPortrait,
            ctaLabel: 'Portfolio ansehen',
            ctaHref: '/portfolio',
          },
          {
            kicker: '04 · Ausgabe',
            title: 'Ich liefere Assets, die wirklich verwendbar sind.',
            text: 'Aus der Produktion entstehen Dateien für Website, Social, Kampagne, Recruiting und Präsentation – sauber sortiert und visuell konsistent.',
    ...
    },
    {
      type: 'bentoGrid',
      data: {
        headline: 'Was der Workflow konkret liefert.',
        subline: 'Kein Technik-Showcase, sondern bessere Vorbereitung und verwertbare Ergebnisse.',
        items: [
          { title: 'Lookrichtung', text: 'Farbwelt, Stimmung, Licht und Bildsprache werden vor dem Shooting greifbar.', icon: 'ScanSearch', span: 'wide' },
          { title: 'Motivliste', text: 'Ich plane, welche Motive für Website, Social, Portrait, Kampagne und Detailflächen gebraucht werden.', icon: 'ListChecks' },
          { title: 'Foto + Film', text: 'Wenn Bewegung sinnvoll ist, werden Reel und Film direkt mitgedacht statt nachträglich improvisiert.', icon: 'Clapperboard' },
          { title: 'Varianten', text: 'Zuschnitte, Tonalitäten und Formate werden kontrolliert abgeleitet.', icon: 'PanelsTopLeft' },
          { title: 'Übergabe', text: 'Sie bekommen keine unübersichtliche Rohdatenmasse, sondern sauber benannte Assets für echte Kanäle.', icon: 'FolderCheck', span: 'wide' },
        ],
      },
    },
    {
      ...
      data: {
        badge: 'Projekt',
        headline: 'Wenn Bilder mehr können sollen als gut aussehen.',
        text: 'Ich entwickle die visuelle Richtung, produziere Foto und Film und liefere die passenden Formate für Ihre Kanäle.',
        image: assets.brandBox,
        primaryCta: { label: 'Workflow besprechen', href: '/kontakt' },
