...
function buildSchuktuewAiWorkflowSections(assets: UploadedAssets): PageConfig['sections'] {
  ...
  return [
    ...
    },
    {
      ...
      data: {
        badge: 'Projektfinder',
        headline: 'Welche Produktion passt zu Ihrem Auftritt?',
        subline: 'Ein kurzer Einstieg, um den richtigen Umfang zu finden: Portrait, Kampagne, Content-Produktion oder freies Projekt.',
        mode: 'score',
        restartLabel: 'Neu wählen',
        questions: [
          {
            id: 'goal',
            label: 'Was soll nach der Produktion vor allem besser funktionieren?',
            description: 'Wählen Sie den Schwerpunkt, der dem Projekt am nächsten kommt.',
            answers: [
              { id: 'trust', label: 'Menschen sichtbar machen', description: 'Portraits, Persönlichkeit, Nähe und Vertrauen.', scores: [{ resultId: 'personal', points: 8 }, { resultId: 'campaign', points: 2 }] },
              { id: 'brand', label: 'Marke oder Angebot schärfen', description: 'Website, Kampagne, Positionierung und visuelle Linie.', scores: [{ resultId: 'campaign', points: 8 }, { resultId: 'content', points: 3 }] },
              { id: 'motion', label: 'Mehr Content für Kanäle', description: 'Foto, Film, Reel, Varianten und wiederkehrende Ausgabe.', scores: [{ resultId: 'content', points: 9 }, { resultId: 'campaign', points: 3 }] },
              { id: 'editorial', label: 'Freies/editoriales Thema', description: 'Dokumentarisch, künstlerisch oder publizistisch gedacht.', scores: [{ resultId: 'editorial', points: 9 }] },
            ],
          },
          {
            id: 'format',
            label: 'Wo sollen die Motive hauptsächlich eingesetzt werden?',
            answers: [
              { id: 'website', label: 'Website und Präsentation', scores: [{ resultId: 'campaign', points: 5 }, { resultId: 'personal', points: 3 }] },
              { id: 'social', label: 'Social, Reels und Ads', scores: [{ resultId: 'content', points: 6 }, { resultId: 'campaign', points: 2 }] },
              { id: 'press', label: 'Presse, Editorial, Buch oder Print', scores: [{ resultId: 'editorial', points: 6 }, { resultId: 'personal', points: 2 }] },
              { id: 'mix', label: 'Mehrere Kanäle gleichzeitig', scores: [{ resultId: 'content', points: 5 }, { resultId: 'campaign', points: 5 }] },
            ],
          },
          {
            id: 'need',
            label: 'Was brauchen Sie eher?',
            answers: [
              { id: 'direction', label: 'Erst eine klare visuelle Richtung', scores: [{ resultId: 'campaign', points: 5 }, { resultId: 'editorial', points: 2 }] },
              { id: 'set', label: 'Ein geführtes Shooting', scores: [{ resultId: 'personal', points: 5 }, { resultId: 'campaign', points: 2 }] },
              { id: 'system', label: 'Ein Paket aus Foto, Film und Varianten', scores: [{ resultId: 'content', points: 7 }] },
              { id: 'story', label: 'Eine eigenständige Bildgeschichte', scores: [{ resultId: 'editorial', points: 6 }] },
            ],
          },
        ],
        results: [
          { id: 'personal', title: 'Personal Branding / Portrait', text: 'Ich entwickle eine Bildstrecke, die Persönlichkeit, Haltung und Vertrauen sichtbar macht.', image: assets.personalBranding, features: ['Portraitführung', 'Website- und Profilmotive', 'saubere Auswahl und Retusche'], cta: { label: 'Portraitprojekt anfragen', href: '/kontakt' } },
          { id: 'campaign', title: 'Business & Kampagne', text: 'Ich plane eine visuelle Linie für Website, Angebot, Recruiting oder Kampagne.', image: assets.businessCampaign, features: ['Looktests', 'Hero- und Detailmotive', 'Formate für mehrere Kanäle'], cta: { label: 'Kampagne planen', href: '/kontakt' } },
          { id: 'content', title: 'Foto + Film Content-Produktion', text: 'Ich denke Still, Bewegung und Varianten zusammen, damit aus einem Produktionstag mehr verwendbares Material entsteht.', image: assets.heroPortrait, features: ['Foto und Reel mitgedacht', 'Zuschnitte für Social und Website', 'strukturierte Übergabe'], cta: { label: 'Content-Produktion anfragen', href: '/kontakt' } },
          { id: 'editorial', title: 'Freies oder editoriales Projekt', text: 'Ich arbeite dokumentarisch und konzentriert, wenn eine Geschichte, ein Raum oder ein Thema fotografisch getragen werden soll.', image: assets.archiveStill02, features: ['Recherche und Bildidee', 'ruhige Bildführung', 'Serie statt Einzelmotiv'], cta: { label: 'Editorial besprechen', href: '/kontakt' } },
        ],
      },
      styleOverrides: darkAiStyle,
    },
    {
      ...
      data: {
        badge: 'Nutzen',
        headline: 'Der Workflow spart Entscheidungen an der falschen Stelle.',
        subline: 'Die Arbeit wird nicht technischer. Sie wird klarer vorbereitet und am Ende besser verwendbar.',
        proofs: [
          { value: 'vorab', label: 'Wirkung prüfen', note: 'Look, Farbe und Zuschnitt werden sichtbar, bevor produziert wird.' },
          { value: 'mehrfach', label: 'Formate nutzen', note: 'Ein Motiv wird direkt für Website, Social, Kampagne und Print gedacht.' },
          { value: 'sauber', label: 'Assets übergeben', note: 'Auswahl, Benennung und Varianten sind Teil der Lieferung.' },
        ],
        reviews: [
          { quote: 'Ich will, dass Bilder nicht nur schön sind, sondern im Auftritt arbeiten.', name: 'Alexander Schuktuew', context: 'Arbeitsprinzip' },
          { quote: 'KI ist interessant, wenn sie Entscheidungen vorbereitet — nicht wenn sie Fotografie ersetzt.', name: 'Alexander Schuktuew', context: 'AI Workflow' },
        ],
      },
      styleOverrides: darkAiStyle,
    },
