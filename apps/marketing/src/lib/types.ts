...
const templateKeyZ = z.enum(['restaurant', 'hotel', 'tourism', 'salon', 'tradesman', 'consulting', 'medical', 'fitness', 'wedding', 'photography', 'realestate', 'cafe', 'tattoo']);
...
export type TemplateKey = 'restaurant' | 'hotel' | 'tourism' | 'salon' | 'tradesman' | 'consulting' | 'medical' | 'fitness' | 'wedding' | 'photography' | 'realestate' | 'cafe' | 'tattoo';
