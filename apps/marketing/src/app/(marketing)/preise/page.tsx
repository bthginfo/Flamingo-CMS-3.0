...
export const metadata: Metadata = {
  ...
  description:
    'Drei klare Pakete: Template ab 1.490 €, mit Foto- & Video-Content-Kit ab 3.180 €, oder komplett individuell. Transparente Festpreise, keine versteckten Kosten. Hosting ab 29 €/Monat.',
