...
const TEMPLATES = [
  ...
  },
  {
    ...
    color: '#8B4513',
    features: ['Editierbare Speisekarte', 'Reservierungs-CTA', 'Oeffnungszeiten', 'Signature-Gerichte', 'Events & Feiern', 'Ambiente-Galerie'],
    status: 'live' as const,
  },
  {
    key: 'salon',
    ...
    description: 'Premium-Template mit Online-Buchung, Service-Menue, Preisliste, Team, Galerie, Vorher/Nachher und Bewertungen.',
    image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&q=80',
    color: '#C2185B',
    features: ['Service-Menue', 'Preisliste', 'Online-Buchung', 'Team', 'Vorher/Nachher', 'Bewertungen'],
    status: 'live' as const,
  },
  {
    key: 'hotel',
    ...
    color: '#1B5E20',
    features: ['Zimmerkatalog', 'Buchungs-CTA', 'Angebote & Arrangements', 'Wellness & Restaurant', 'Lage & Umgebung', 'Eventräume'],
    status: 'live' as const,
  },
  {
    key: 'tourism',
    name: 'Tourismus',
    tagline: 'Regionen, Orte & Erlebnisanbieter',
    description: 'Destinations-Template mit Erlebnissen, Routen, Veranstaltungen, Unterkuenften, Besucherinfos und Tourismusbuero-Kontakt.',
    image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=80',
    color: '#2f6f4e',
    features: ['Destination-Highlights', 'Erlebnis-Grid', 'Events & Kalender', 'Routen & Touren', 'Unterkuenfte', 'Besucherinfos'],
    status: 'live' as const,
  },
  {
    key: 'medical',
    ...
    description: 'Serioeses Praxis-Template mit Leistungen, Aerzteteam, Patienteninfo, Terminbuchung, Sprechzeiten und Notfallhinweisen.',
    image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&q=80',
    color: '#0f4c5c',
    features: ['Leistungen', 'Aerzteteam', 'Patienteninfo', 'Terminbuchung', 'Sprechzeiten', 'Notfallhinweise'],
    status: 'live' as const,
  },
  {
    key: 'consulting',
