...
const TEMPLATES = [
  ...
  },
  {
    ...
    description: 'Bouquets, Hochzeiten, Workshops, saisonale Kampagnen, Standorte und Kontakt als moderne, emotionale Markenwelt.',
    image: 'https://images.unsplash.com/photo-1487070183336-b863922373d4?w=800&q=80',
    color: '#be185d',
    features: ['Bouquet-Showcase', 'Hochzeitsfloristik', 'Workshops & Events', 'Saisonale Kampagnen', 'Weitere Standorte', 'Kontakt & Beratung'],
    status: 'live' as const,
  },
  {
    key: 'fitness',
    ...
    description: 'Programme, Trainer, Probetraining, Kurspläne und Angebote als energiegeladene Website für Studios und Coaches.',
    image: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&q=80',
    color: '#9333ea',
    features: ['Programme & Kurse', 'Trainer:innen', 'Probetraining-CTA', 'Preise & Pakete', 'Bewertungen', 'Kontakt'],
    status: 'live' as const,
  },
  {
    key: 'location',
    name: 'Location',
    tagline: 'Eventlocation, Hochzeitslocation & Coworking',
    description: 'Räume, Kapazitäten, Eventarten, Pakete, Ausstattung, Galerie und Anfrage-CTA als hochwertige Location-Website.',
