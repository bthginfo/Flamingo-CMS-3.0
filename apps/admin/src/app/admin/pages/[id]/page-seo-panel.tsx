...
export function PageSeoPanel({ pageId }: { pageId: string }) {
      ...
      {open && (
        <div className="px-4 pb-4 space-y-3 border-t pt-3">
          <div>
            ...
            <input className="admin-input" value={data.metaTitle} onChange={e => setData(d => ({ ...d, metaTitle: e.target.value }))} placeholder="Seitentitel für Suchmaschinen" maxLength={70} />
