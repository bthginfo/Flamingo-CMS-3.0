...
export function MapSection({ data }: Props) {
  ...
  return (
    ...
    >
      {headline && <h2 className="section-headline mb-10 text-[var(--token-heading)]" data-edit-path="headline">{headline}</h2>}
      <div className="overflow-hidden rounded-3xl border border-[var(--token-card-border)] bg-[var(--token-card-bg)] p-2 shadow-xl">
        <div className="rounded-2xl overflow-hidden">
          {embedUrl ? (
            ...
            <div className={`flex w-full ${height} items-center justify-center bg-[var(--token-section-bg-alt)] text-[var(--token-muted)]`}>
              <div className="text-center">
                <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-xl bg-[var(--token-card-bg)]">
                  <svg className="h-8 w-8 text-[var(--token-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
