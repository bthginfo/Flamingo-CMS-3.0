      ...
      <div className="relative z-10 text-center text-[color:var(--token-on-dark-heading,#ffffff)] px-6 py-12 md:py-20 sm:py-16 md:py-24 lg:py-32">
        ...
        {cta?.label && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.5 }}>
            <a href={cta.href} className="group inline-flex items-center gap-2.5 rounded-full bg-[var(--token-btn-bg, var(--brand-btn-bg,var(--style-accent-color,var(--token-eyebrow, var(--brand-accent)))))] px-8 py-4 font-semibold text-[var(--token-btn-text, var(--brand-btn-text,#111827))] transition-all hover:-translate-y-0.5 hover:brightness-110">
