        ...
        {items.map((item, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: i * 0.15 }}
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-gray-500 leading-relaxed mb-6 rt-content" dangerouslySetInnerHTML={{ __html: item.text }} />
        ...
        {items.map((item, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: i * 0.1 }}>
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-gray-400 leading-loose rt-content" dangerouslySetInnerHTML={{ __html: item.text }} />
              {item.features && item.features.length > 0 && (
        ...
        {items.map((item, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.4, delay: i * 0.1 }}
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 leading-relaxed rt-content" dangerouslySetInnerHTML={{ __html: item.text }} />
              {item.features && item.features.length > 0 && (
