        ...
        {items.map((item, i) => (
          <motion.div
           ...
           data-edit-collection="items" data-edit-index={i}>
            <p className="leading-relaxed text-[var(--token-body, var(--style-body-color,var(--style-text-secondary,#4b5563)))] italic">&ldquo;<span data-edit-path="quote">{plain(item.quote)}</span>&rdquo;</p>
