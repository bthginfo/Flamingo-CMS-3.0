    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          {p.primaryCta.label && <a href={p.primaryCta.href || '#'} className="inline-flex rounded-full px-5 py-3 font-semibold shadow-md" style={{ background: 'var(--token-btn-bg,#111827)', color: 'var(--token-btn-text,var(--token-on-dark-heading))' }} data-edit-path="label">{p.primaryCta.label}</a>}
          {p.secondaryCta.label && <a href={p.secondaryCta.href || '#'} className="inline-flex rounded-full border px-5 py-3 font-semibold" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-heading))', borderColor: 'var(--token-btn-secondary-border,color-mix(in_srgb,var(--token-icon)_30%,transparent))' }} data-edit-path="label">{p.secondaryCta.label}</a>}
        </div>
      </div>
  ...
  return (
    <div className="grid gap-16 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          {p.primaryCta.label && <a href={p.primaryCta.href || '#'} className="inline-flex border px-6 py-3 font-light" style={{ background: 'var(--token-btn-bg,transparent)', color: 'var(--token-btn-text,var(--token-heading))', borderColor: 'var(--token-btn-bg,#111827)' }} data-edit-path="label">{p.primaryCta.label}</a>}
          {p.secondaryCta.label && <a href={p.secondaryCta.href || '#'} className="inline-flex px-6 py-3 font-light" style={{ color: 'var(--token-btn-secondary-text,var(--token-muted))' }} data-edit-path="label">{p.secondaryCta.label}</a>}
        </div>
      </div>
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          {p.primaryCta.label && <a href={p.primaryCta.href || '#'} className="inline-flex px-6 py-3 font-black uppercase shadow-[4px_4px_0_rgba(0,0,0,0.8)]" style={{ background: 'var(--token-btn-bg,var(--token-badge-bg))', color: 'var(--token-btn-text,var(--token-on-dark-heading))' }} data-edit-path="label">{p.primaryCta.label}</a>}
          {p.secondaryCta.label && <a href={p.secondaryCta.href || '#'} className="inline-flex border-2 px-6 py-3 font-black uppercase shadow-[4px_4px_0_var(--token-eyebrow)]" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-heading))', borderColor: 'var(--token-btn-secondary-border,#111827)' }} data-edit-path="label">{p.secondaryCta.label}</a>}
        </div>
      </div>
