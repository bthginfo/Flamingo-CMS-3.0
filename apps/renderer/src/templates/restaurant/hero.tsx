      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.4 }}
            className="text-5xl sm:text-6xl lg:text-8xl font-[700] leading-[0.95] text-[color:var(--token-on-dark-heading,#ffffff)]"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center py-12 md:py-20">
        ...
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6 mt-12">
            ...
            {secondaryCta.label && (
              <a href={secondaryCta.href || '#'}
                className="inline-flex items-center gap-2 text-[color:var(--token-muted,#71717a)] hover:text-[color:var(--token-muted,#52525b)] transition-colors text-sm" data-edit-path="label">
                {secondaryCta.label}
              </a>
            )}
          </div>
        ...
        <div className="max-w-5xl">
          ...
          {badgeText && (
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4 }}
              className="inline-block bg-[var(--token-badge-bg,var(--brand-accent,#f39c12))] text-[color:var(--token-heading,#18181b)] font-bold text-xs uppercase tracking-widest px-4 py-2 mb-8">
              {badgeText}
            </motion.div>
          )}
