...
export function DailySpecialsSection({ data }: Props) {
  const headline = typeof data.headline === 'string' ? data.headline : 'Wochenkarte';
        ...
        <div className="space-y-4">
          {specials.map((item, i) => (
            <motion.div
              ...
              className="flex items-start gap-4 bg-[var(--token-card-bg)] rounded-lg p-5 border border-amber-100 shadow-sm"
