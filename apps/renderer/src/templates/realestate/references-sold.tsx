            ...
            <motion.div
             ...
             data-edit-collection="properties" data-edit-index={i}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                ...
                {prop.price && <p className="text-[color:var(--token-price)] font-semibold text-sm mt-1" data-edit-path="price">{prop.price}</p>}
                {prop.soldIn && <p className="mt-1 text-xs font-semibold text-[color:var(--token-card-muted)]">Vermittelt in {prop.soldIn}</p>}
              </div>
            </motion.div>
          ))}
        </div>
