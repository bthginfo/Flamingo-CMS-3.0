    ...
    <section className="relative min-h-screen overflow-hidden -mt-[112px] pt-[112px] bg-[var(--token-section-bg)]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-112px)] max-w-7xl flex-col items-center justify-center px-6 py-12 md:py-20 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }} className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          {emergencyCta.label && <a data-edit-link="emergencyCta" href={emergencyCta.href || '#'} className="inline-flex items-center gap-2 rounded-full bg-[var(--token-danger-bg,theme(colors.red.600))] px-6 py-3 font-semibold text-[color:var(--token-on-dark-heading)]">{emergencyCta.icon && <DynamicIcon editPath="emergencyCta.icon" name={emergencyCta.icon} size={17} />}<span data-edit-path="label">{emergencyCta.label}</span></a>}
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.6 }} className="mt-10 flex flex-wrap justify-center gap-3 text-sm text-[color:var(--token-on-dark-body)]">
          ...
          {trustItems.map((item) => <span key={item} className="inline-flex items-center gap-1.5 rounded-full bg-[var(--token-badge-bg)] px-4 py-2"><CheckCircle size={14} className="text-[color:var(--token-icon)]" />{item}</span>)}
        </motion.div>
      </div>
    </section>
  );
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-112px)] max-w-7xl items-center gap-10 px-6 py-12 md:py-20 lg:grid-cols-2">
        <div className="max-w-xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            {emergencyCta.label && <a data-edit-link="emergencyCta" href={emergencyCta.href || '#'} className="inline-flex items-center gap-2 rounded-lg bg-[var(--token-danger-bg,theme(colors.red.600))] px-5 py-3 font-semibold text-[color:var(--token-on-dark-heading)]">{emergencyCta.icon && <DynamicIcon editPath="emergencyCta.icon" name={emergencyCta.icon} size={17} />}<span data-edit-path="label">{emergencyCta.label}</span></a>}
          ...
          <div className="mt-10 flex flex-wrap gap-3 text-sm text-[color:var(--token-body)]">
            ...
            {emergencyHint && <span className="rounded-full border border-[var(--token-danger,theme(colors.red.200))] bg-[var(--token-danger-bg,theme(colors.red.50))] px-4 py-2 text-[var(--token-danger,theme(colors.red.700))]">{emergencyHint}</span>}
...
function HeroBold({ headline, subline, badgeText, badgeIcon, bgImage, bgImageMobile, bgColor, bgMode, specialtyLabel, emergencyHint, trustItems, primaryCta, emergencyCta, secondaryCta , bgPosition, bgPositionMobile, imageEffect, imageEffectIntensity}: HeroProps) {
  return (
    <section className="relative min-h-screen overflow-hidden -mt-[112px] pt-[112px] bg-[var(--token-section-bg)]">
      ...
      <div className="absolute left-10 top-1/4 opacity-10" aria-hidden="true"><Cross size={200} className="text-[color:var(--token-icon)]" /></div>
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-112px)] max-w-7xl flex-col justify-center px-6 py-12 md:py-20">
        <div className="flex items-center gap-3">
          <DynamicIcon name={badgeIcon} className="text-[color:var(--token-badge-text)]" size={28} />
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          {emergencyCta.label && <a data-edit-link="emergencyCta" href={emergencyCta.href || '#'} className="inline-flex items-center gap-2 border-2 border-[var(--token-danger,theme(colors.red.500))] bg-[var(--token-danger-bg,theme(colors.red.500))] px-6 py-3 font-black uppercase text-[color:var(--token-on-dark-heading)] shadow-[4px_4px_0_theme(colors.red.800)]">{emergencyCta.icon && <DynamicIcon editPath="emergencyCta.icon" name={emergencyCta.icon} size={17} />}<span data-edit-path="label">{emergencyCta.label}</span></a>}
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm text-[color:var(--token-body)]">
          ...
          {emergencyHint && <span className="border border-red-500/40 px-4 py-2 font-bold uppercase text-[var(--token-danger,theme(colors.red.400))]">{emergencyHint}</span>}
