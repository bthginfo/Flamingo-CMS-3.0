    ...
    <section data-theme={isBold ? 'dark' : undefined} className={sectionClasses}>
      <div className="max-w-7xl mx-auto">
        <div className={isModern ? 'mb-16' : 'text-center mb-12'}>
          ...
          {isModern && <p className="text-[10px] uppercase tracking-[0.3em] text-[color:var(--token-on-dark-body,#a1a1aa)] mb-4">{badge}</p>}
        ...
        {cta?.label && (
          <div className={`${isModern ? '' : 'text-center'} mt-12`}>
            <a href={cta.href} className={isModern ? 'inline-block text-sm text-[color:var(--token-heading,#18181b)] border-b border-gray-900 hover:opacity-70' : isBold ? 'inline-flex items-center gap-2 px-8 py-3.5 bg-[var(--token-badge-bg,var(--brand-accent,#f39c12))] text-[color:var(--token-heading,#000000)] font-bold uppercase tracking-wider hover:opacity-90 transition-opacity' : 'inline-flex items-center gap-2 px-8 py-3.5 bg-[var(--token-btn-bg,var(--brand-primary,#1a5276))] text-[color:var(--token-on-dark-heading,#ffffff)] font-semibold rounded-full hover:opacity-90 transition-opacity shadow-lg'}>
              {cta.label}
