      ...
      <section className="py-24 md:py-36 px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              {description && <div className="text-[color:var(--token-on-dark-muted,#71717a)] leading-relaxed rt-content" dangerouslySetInnerHTML={{ __html: description }} />}
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className={image ? '' : 'md:col-span-2'}>
              {description && <div className="text-[color:var(--token-on-dark-muted,#3f3f46)] text-lg leading-relaxed mb-8 rt-content" dangerouslySetInnerHTML={{ __html: description }} />}
              <div className="space-y-4 border-l-4 border-[var(--token-card-border,var(--brand-accent,#f39c12))] pl-6">
                {address && <p className="text-[color:var(--token-on-dark-muted,#3f3f46)] flex items-center gap-2"><MapPin className="w-4 h-4 text-[color:var(--token-eyebrow,var(--brand-accent,#f39c12))]" />{address}</p>}
                {contact && <p className="text-[color:var(--token-on-dark-muted,#3f3f46)] flex items-center gap-2"><Phone className="w-4 h-4 text-[color:var(--token-eyebrow,var(--brand-accent,#f39c12))]" />{contact}</p>}
              </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className={image ? '' : 'md:col-span-2 max-w-3xl mx-auto text-center'}>
            {description && <div className="text-[color:var(--token-on-dark-muted,#52525b)] text-lg leading-relaxed mb-8 rt-content" dangerouslySetInnerHTML={{ __html: description }} />}
            <div className="space-y-4">
              {address && <div className="flex items-start gap-3"><MapPin className="w-5 h-5 text-[color:var(--token-icon,var(--brand-primary,#1a5276))] mt-0.5 shrink-0" /><p className="text-[color:var(--token-on-dark-muted,#3f3f46)]">{address}</p></div>}
              {contact && <div className="flex items-start gap-3"><Phone className="w-5 h-5 text-[color:var(--token-icon,var(--brand-primary,#1a5276))] mt-0.5 shrink-0" /><p className="text-[color:var(--token-on-dark-muted,#3f3f46)]">{contact}</p></div>}
            </div>
              ...
              {directions.map((d, i) => {
                ...
                return (
                  <motion.div key={i} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="flex gap-6 border-t border-[color:var(--token-card-border,#e4e4e7)] pt-6">
                    <Icon className="w-5 h-5 text-[color:var(--token-on-dark-body,#a1a1aa)] shrink-0 mt-1" />
                    <div>
                      <h3 className="text-base font-light text-[color:var(--token-heading,#18181b)]">{d.title}</h3>
                      <div className="text-[color:var(--token-on-dark-muted,#71717a)] text-sm mt-2 rt-content" dangerouslySetInnerHTML={{ __html: d.text }} />
                    </div>
                  </motion.div>
                );
              })}
              ...
              {accommodations.map((a, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="border-2 border-gray-900 overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    {a.description && <div className="text-[color:var(--token-on-dark-muted,#52525b)] text-sm mt-1 rt-content" dangerouslySetInnerHTML={{ __html: a.description }} />}
            ...
            {directions.map((d, i) => {
              ...
              return (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="text-center p-6 rounded-xl bg-[var(--token-card-bg,#ffffff)] shadow-sm">
                  ...
                  <h3 className="font-semibold text-[color:var(--token-heading,#18181b)] mb-2">{d.title}</h3>
                  <div className="text-[color:var(--token-on-dark-muted,#52525b)] text-sm rt-content" dangerouslySetInnerHTML={{ __html: d.text }} />
                </motion.div>
              );
            })}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {accommodations.map((a, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl overflow-hidden bg-[var(--token-card-bg,#ffffff)] shadow-sm border border-[color:var(--token-card-border,#f4f4f5)]">
                  {a.image && <div className="relative h-40"><Image src={a.image} alt={a.name} fill className="object-cover" /></div>}
                  <div className="p-5">
                    <h4 className="font-semibold text-[color:var(--token-heading,#18181b)]">{a.name}</h4>
                    {a.description && <div className="text-[color:var(--token-on-dark-muted,#52525b)] text-sm mt-1 rt-content" dangerouslySetInnerHTML={{ __html: a.description }} />}
