        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4 border-t border-[color:var(--token-card-border,#e4e4e7)] pt-6 md:border-t-0 md:pt-0 md:border-l md:pl-12">
              {address && <p className="text-[color:var(--token-muted,#52525b)] text-sm">{address}</p>}
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className={image ? '' : 'md:col-span-2 max-w-3xl mx-auto text-center'}>
            ...
            <div className="space-y-4">
              {address && <div className="flex items-start gap-3"><MapPin className="w-5 h-5 text-[color:var(--token-icon,var(--brand-primary,#1a5276))] mt-0.5 shrink-0" /><p className="text-[color:var(--token-muted,#3f3f46)]">{address}</p></div>}
