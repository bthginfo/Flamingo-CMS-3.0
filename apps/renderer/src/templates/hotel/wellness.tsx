      ...
      {treatments.length > 0 && (
        ...
        {treatments.map((treatment, index) => (
          <motion.article key={`${treatment.title}-${index}`} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="rounded-xl border border-[color-mix(in_srgb,var(--token-icon)_20%,transparent)] bg-[var(--token-card-bg)] p-5 shadow-md" data-edit-collection="treatments" data-edit-index={index}>
            ...
            <div className="flex justify-between gap-4"><h3 className="font-bold text-[color:var(--token-heading)]" data-edit-path="title">{treatment.title || ''}</h3><span className="text-sm text-[color:var(--token-price,var(--token-muted))]" data-edit-path="priceLabel">{treatment.priceLabel || ''}</span></div>
      ...
      <div className="space-y-5">
        ...
        {treatments.map((treatment, index) => (
          <article key={`${treatment.title || 'item'}-${index}`} className="border border-black/10 bg-[var(--token-card-bg)] p-6" data-edit-collection="treatments" data-edit-index={index}>
            ...
            <div className="flex justify-between gap-4"><h3 className="font-light text-[color:var(--token-heading)]" data-edit-path="title">{treatment.title || ''}</h3><span className="text-sm font-light text-[color:var(--token-price,var(--token-muted))]" data-edit-path="priceLabel">{treatment.priceLabel || ''}</span></div>
      ...
      <div className="space-y-5">
        ...
        {treatments.map((treatment, index) => (
          <article key={`${treatment.title || 'item'}-${index}`} className="border-2 border-[var(--token-card-border)] bg-[var(--token-card-bg)] p-5 shadow-[4px_4px_0_var(--token-card-border)]" data-edit-collection="treatments" data-edit-index={index}>
            ...
            <div className="flex justify-between gap-4"><h3 className="font-black uppercase text-[color:var(--token-heading)]" data-edit-path="title">{treatment.title || ''}</h3><span className="text-sm font-bold text-[color:var(--token-price,var(--token-muted))]" data-edit-path="priceLabel">{treatment.priceLabel || ''}</span></div>
            {treatment.text && <div className="mt-2 text-sm text-[color:var(--token-muted)] rt-content" data-edit-rich="text" dangerouslySetInnerHTML={{ __html: treatment.text }} />}
