  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        {introText && <div className="text-[color:var(--token-on-dark-muted,#52525b)] leading-7 rt-content" dangerouslySetInnerHTML={{ __html: introText }} />}
        <div className="mt-8 grid gap-4">
          {features.map((feature, index) => (
            <motion.div key={`${feature.title}-${index}`} initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="flex gap-4 border-t border-[var(--token-icon, var(--brand-primary))]/20 pt-4">
              ...
              <div><h3 className="font-semibold text-[color:var(--token-heading,#18181b)]">{feature.title || ''}</h3>{feature.text && <div className="text-sm text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: feature.text }} />}</div>
            </motion.div>
          ))}
        </div>
      ...
      <div className="space-y-5">
        ...
        {treatments.map((treatment, index) => (
          <motion.article key={`${treatment.title}-${index}`} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="rounded-xl border border-[var(--token-icon, var(--brand-primary))]/20 bg-[var(--token-card-bg,#ffffff)] p-5 shadow-md">
            ...
            <div className="flex justify-between gap-4"><h3 className="font-bold text-[color:var(--token-heading,#18181b)]">{treatment.title || ''}</h3><span className="text-sm text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.priceLabel || ''}</span></div>
            {treatment.text && <div className="mt-2 text-sm text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: treatment.text }} />}
            {treatment.durationLabel && <p className="mt-2 text-xs text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.durationLabel}</p>}
  ...
  return (
    <div className="grid gap-12 lg:grid-cols-2">
      <div>
        ...
        {introText && <div className="font-light text-[color:var(--token-on-dark-muted,#52525b)] leading-7 rt-content" dangerouslySetInnerHTML={{ __html: introText }} />}
        <div className="mt-8 grid gap-4">
          {features.map((feature, index) => (
            <div key={`${feature.title}-${index}`} className="flex gap-4 border-t border-black/10 pt-4">
              <DynamicIcon name={feature.icon || 'heart'} size={18} className="text-[color:var(--token-on-dark-muted,#52525b)]" />
              <div><h3 className="font-light text-[color:var(--token-heading,#18181b)]">{feature.title || ''}</h3>{feature.text && <div className="text-sm font-light text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: feature.text }} />}</div>
            </div>
          ))}
        </div>
      ...
      <div className="space-y-5">
        ...
        {treatments.map((treatment, index) => (
          <article key={`${treatment.title}-${index}`} className="border border-black/10 bg-[var(--token-card-bg,#ffffff)] p-6">
            ...
            <div className="flex justify-between gap-4"><h3 className="font-light text-[color:var(--token-heading,#18181b)]">{treatment.title || ''}</h3><span className="text-sm font-light text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.priceLabel || ''}</span></div>
            {treatment.text && <div className="mt-2 text-sm font-light text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: treatment.text }} />}
            {treatment.durationLabel && <p className="mt-2 text-xs font-light text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.durationLabel}</p>}
        ...
        <div className="mt-8 grid gap-4">
          {features.map((feature, index) => (
            <div key={`${feature.title}-${index}`} className="flex gap-4 border-t-2 border-[#111827] pt-4">
              <div className="text-[color:var(--token-icon,var(--brand-primary,#1a5276))]"><DynamicIcon name={feature.icon || 'heart'} size={20} /></div>
              <div><h3 className="font-black uppercase text-[color:var(--token-heading,#18181b)]">{feature.title || ''}</h3>{feature.text && <div className="text-sm text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: feature.text }} />}</div>
            </div>
          ))}
        </div>
      ...
      <div className="space-y-5">
        ...
        {treatments.map((treatment, index) => (
          <article key={`${treatment.title}-${index}`} className="border-2 border-[#111827] bg-[var(--token-card-bg,#ffffff)] p-5 shadow-[4px_4px_0_#111827]">
            ...
            <div className="flex justify-between gap-4"><h3 className="font-black uppercase text-[color:var(--token-heading,#18181b)]">{treatment.title || ''}</h3><span className="text-sm font-bold text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.priceLabel || ''}</span></div>
            {treatment.text && <div className="mt-2 text-sm text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: treatment.text }} />}
            {treatment.durationLabel && <p className="mt-2 text-xs font-bold text-[color:var(--token-on-dark-muted,#52525b)]">{treatment.durationLabel}</p>}
