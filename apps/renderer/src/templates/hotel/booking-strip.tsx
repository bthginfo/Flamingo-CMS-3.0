  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-[var(--token-icon)]/20 bg-[var(--token-card-bg)] p-6 shadow-lg text-center">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        ...
        {secondaryCta.label && <a href={secondaryCta.href || '#'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-xl border border-black/15 px-6 py-3 font-semibold text-[color:var(--token-heading)]" data-edit-path="label">{secondaryCta.label}</a>}
      </div>
  ...
  return (
    <div className="border border-black/10 bg-[var(--token-card-bg)] p-8 text-center">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
        {submitCta.label && <a href={submitCta.href || '#'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-light text-[color:var(--token-heading)] underline underline-offset-4"><CalendarDays size={16} /><span data-edit-path="label">{submitCta.label}</span></a>}
        {secondaryCta.label && <a href={secondaryCta.href || '#'} target="_blank" rel="noopener noreferrer" className="font-light text-[color:var(--token-muted)] underline underline-offset-4" data-edit-path="label">{secondaryCta.label}</a>}
      </div>
  ...
  return (
    <div className="border-2 border-[#111827] bg-[var(--token-card-bg)] p-6 shadow-[4px_4px_0_#111827] text-center">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        ...
        {secondaryCta.label && <a href={secondaryCta.href || '#'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border-2 border-[#111827] px-6 py-3 font-black uppercase text-[color:var(--token-heading)]" data-edit-path="label">{secondaryCta.label}</a>}
      </div>
