...
function HeroClassic({ headline, subline, badgeText, badgeIcon, trustItems, bgImage, bgImageMobile, bgColor, bgMode, primaryCta, secondaryCta, availabilityHint, ratingText, overlayColor, overlayOpacity, bgPosition, bgPositionMobile, imageEffect, imageEffectIntensity}: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden -mt-[112px] pt-[112px]">
      ...
      {/* scattered stars */}
      <div className="absolute top-1/4 left-[15%] text-[color:color-mix(in_srgb,var(--token-on-dark-heading)_18%,transparent)]"><Star size={24} /></div>
      <div className="absolute top-[60%] right-[20%] text-[color:color-mix(in_srgb,var(--token-on-dark-heading)_14%,transparent)]"><Star size={18} /></div>
      <div className="absolute top-[35%] right-[10%] text-[color:color-mix(in_srgb,var(--token-on-dark-heading)_10%,transparent)]"><Star size={32} /></div>
      {/* border lines */}
      ...
      <motion.div style={{ opacity, y }} className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12 md:py-20 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.9 }}
          ...
          {secondaryCta.label && (
            <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex items-center justify-center rounded-full border border-[color:color-mix(in_srgb,var(--token-on-dark-heading)_34%,transparent)] bg-[color:color-mix(in_srgb,var(--token-on-dark-heading)_8%,transparent)] px-7 py-4 font-semibold text-[color:var(--token-on-dark-heading)] transition-colors hover:border-[color:color-mix(in_srgb,var(--token-on-dark-heading)_62%,transparent)]" style={{ background: 'var(--token-btn-secondary-bg,color-mix(in_srgb,var(--token-on-dark-heading)_8%,transparent))', color: 'var(--token-btn-secondary-text,var(--token-on-dark-heading))', borderColor: 'var(--token-btn-secondary-border,color-mix(in_srgb,var(--token-on-dark-heading)_34%,transparent))' }} data-edit-path="label">
              {secondaryCta.label}
            </a>
          )}
        </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-12 md:py-20">
        <div className="max-w-5xl">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
            ...
            {ratingText && <span className="flex items-center gap-2"><Star size={14} className="text-[color:var(--token-on-dark-body)]" />{ratingText}</span>}
