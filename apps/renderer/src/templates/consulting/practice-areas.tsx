        ...
        {areas.map((area, i) => {
          const card = (
            <motion.div
              ...
              className="group relative p-8 rounded-xl border border-slate-200 bg-white hover:border-[var(--token-card-border,var(--brand-primary,#1a5276))/30] hover:shadow-lg transition-all duration-300"
            >
              {area.icon && (
                <div className="w-12 h-12 mb-5 rounded-lg bg-[var(--token-btn-bg,var(--brand-primary,#1a5276))/10] flex items-center justify-center text-[color:var(--token-icon,var(--brand-primary,#1a5276))] group-hover:bg-[var(--token-btn-bg,var(--brand-primary,#1a5276))] group-hover:text-white transition-colors">
