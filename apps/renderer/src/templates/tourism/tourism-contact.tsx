    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex items-center gap-2 border-2 border-[var(--token-btn-secondary-border)] px-5 py-3 font-black uppercase text-[color:var(--token-btn-secondary-text)]" data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
