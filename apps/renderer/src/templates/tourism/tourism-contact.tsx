    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex items-center gap-2 rounded-lg border px-5 py-3 font-semibold" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-body))', borderColor: 'var(--token-btn-secondary-border,var(--token-card-border))' }} data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex items-center gap-2 border-2 px-5 py-3 font-black uppercase" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-body))', borderColor: 'var(--token-btn-secondary-border,var(--token-card-border))' }} data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
