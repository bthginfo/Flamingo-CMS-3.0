    ...
    <section className="relative min-h-screen flex items-center overflow-hidden -mt-[112px] pt-[112px]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-12 md:py-20 text-center">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }} className="mt-8 flex flex-wrap justify-center gap-3">
          {primaryCta.label && <a href={primaryCta.href || '#'} className="inline-flex items-center gap-2 rounded-full bg-[var(--token-btn-bg,var(--token-btn-bg, var(--brand-btn-bg,#ffffff)))] px-7 py-3 font-semibold text-[var(--token-btn-text,var(--token-btn-text, var(--brand-btn-text,#111827)))] shadow-lg">{primaryCta.label}{primaryCta.icon && <DynamicIcon name={primaryCta.icon} size={17} />}</a>}
