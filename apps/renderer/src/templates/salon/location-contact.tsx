  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-6 grid gap-3">{infoCards.map((card, i) => <div key={`${card.label}-${i}`} className="flex gap-4 border-t border-[var(--token-icon, var(--brand-primary))]/20 pt-4" data-edit-collection="infoCards" data-edit-index={i}><DynamicIcon name={card.icon || 'mail'} size={20} className="text-[color:var(--token-eyebrow,var(--brand-accent,#f39c12))]" /><div><p className="text-xs text-[color:var(--token-muted,#52525b)]">{card.label || ''}</p><p className="font-semibold text-[color:var(--token-heading,#18181b)]">{card.value || ''}</p></div></div>)}</div>
  ...
  return (
    <div className="grid gap-16 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-6 grid gap-4">{infoCards.map((card, i) => <div key={`${card.label}-${i}`} className="flex gap-4 border-t border-black/10 pt-4" data-edit-collection="infoCards" data-edit-index={i}><DynamicIcon name={card.icon || 'mail'} size={18} className="text-[color:var(--token-eyebrow,var(--brand-accent,#f39c12))]" /><div><p className="text-xs font-light text-[color:var(--token-muted,#52525b)]">{card.label || ''}</p><p className="font-light text-[color:var(--token-heading,#18181b)]">{card.value || ''}</p></div></div>)}</div>
        <div className="mt-8 flex flex-wrap gap-3">
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-6 grid gap-3">{infoCards.map((card, i) => <div key={`${card.label}-${i}`} className="flex gap-4 border-t-2 border-[#111827] pt-4" data-edit-collection="infoCards" data-edit-index={i}><DynamicIcon name={card.icon || 'mail'} size={20} className="text-[color:var(--token-eyebrow,var(--brand-accent,#f39c12))]" /><div><p className="text-xs font-bold uppercase text-[color:var(--token-muted,#52525b)]">{card.label || ''}</p><p className="font-black text-[color:var(--token-heading,#18181b)]">{card.value || ''}</p></div></div>)}</div>
        <div className="mt-8 flex flex-wrap gap-3">
