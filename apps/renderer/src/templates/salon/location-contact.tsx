    ...
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          {primaryCta.label && <a data-edit-link="primaryCta" href={primaryCta.href || '#'} className="inline-flex rounded-full px-5 py-3 font-semibold shadow-md" style={{ background: 'var(--token-btn-bg,#111827)', color: 'var(--token-btn-text,var(--token-on-dark-heading))' }} data-edit-path="label">{primaryCta.label}</a>}
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex rounded-full border px-5 py-3 font-semibold" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-heading))', borderColor: 'var(--token-btn-secondary-border,color-mix(in_srgb,var(--token-icon)_30%,transparent))' }} data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
  ...
  return (
    <div className="grid gap-16 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-6 grid gap-4">{infoCards.map((card, i) => <div key={`$<span data-edit-path="label">{card.label}</span>-${i}`} className="flex gap-4 border-t border-black/10 pt-4" data-edit-collection="infoCards" data-edit-index={i}><DynamicIcon editPath="icon" name={card.icon || 'mail'} size={18} className="text-[color:var(--token-eyebrow)]" /><div><p className="text-xs font-light text-[color:var(--token-muted)]" data-edit-path="label">{card.label || ''}</p><p className="font-light text-[color:var(--token-heading)]" data-edit-path="value">{card.value || ''}</p></div></div>)}</div>
        <div className="mt-8 flex flex-wrap gap-3">
          {primaryCta.label && <a data-edit-link="primaryCta" href={primaryCta.href || '#'} className="inline-flex border px-6 py-3 font-light" style={{ background: 'var(--token-btn-bg,transparent)', color: 'var(--token-btn-text,var(--token-heading))', borderColor: 'var(--token-btn-bg,#111827)' }} data-edit-path="label">{primaryCta.label}</a>}
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex px-6 py-3 font-light" style={{ color: 'var(--token-btn-secondary-text,var(--token-muted))' }} data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-6 grid gap-3">{infoCards.map((card, i) => <div key={`$<span data-edit-path="label">{card.label}</span>-${i}`} className="flex gap-4 border-t-2 border-[#111827] pt-4" data-edit-collection="infoCards" data-edit-index={i}><DynamicIcon editPath="icon" name={card.icon || 'mail'} size={20} className="text-[color:var(--token-eyebrow)]" /><div><p className="text-xs font-bold uppercase text-[color:var(--token-muted)]" data-edit-path="label">{card.label || ''}</p><p className="font-black text-[color:var(--token-heading)]" data-edit-path="value">{card.value || ''}</p></div></div>)}</div>
        <div className="mt-8 flex flex-wrap gap-3">
          {primaryCta.label && <a data-edit-link="primaryCta" href={primaryCta.href || '#'} className="inline-flex px-6 py-3 font-black uppercase shadow-[4px_4px_0_rgba(0,0,0,0.8)]" style={{ background: 'var(--token-btn-bg,var(--token-badge-bg))', color: 'var(--token-btn-text,var(--token-on-dark-heading))' }} data-edit-path="label">{primaryCta.label}</a>}
          {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex border-2 px-6 py-3 font-black uppercase shadow-[4px_4px_0_var(--token-eyebrow)]" style={{ background: 'var(--token-btn-secondary-bg,transparent)', color: 'var(--token-btn-secondary-text,var(--token-heading))', borderColor: 'var(--token-btn-secondary-border,#111827)' }} data-edit-path="label">{secondaryCta.label}</a>}
        </div>
      </div>
