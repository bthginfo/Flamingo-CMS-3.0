      ...
      <div className="divide-y divide-black/10 border-y border-black/10">
        {items.map((item, i) => (
          <details key={`${item.question}-${i}`} className="py-6">
            ...
            {item.answer && <div className="mt-3 text-sm font-light leading-6 text-[color:var(--token-on-dark-muted,#52525b)] rt-content" dangerouslySetInnerHTML={{ __html: item.answer }} />}
          </details>
        ))}
      </div>
