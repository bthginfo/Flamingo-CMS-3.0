        ...
        <div className="mt-16 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {principles.map((item, index) => (
            <motion.article
             ...
             data-edit-collection="principles" data-edit-index={index} data-card>
              ...
              {item.eyebrow && !isNumericEyebrow(item.eyebrow) && <div className="mb-2 text-xs font-bold uppercase tracking-[0.16em] text-[color:var(--token-eyebrow)]" data-edit-path="eyebrow">{item.eyebrow}</div>}
