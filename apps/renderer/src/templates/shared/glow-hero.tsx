      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-end px-6 py-16 md:py-24">
        <div className="max-w-5xl">
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            {secondaryCta.label && <a data-edit-link="secondaryCta" href={secondaryCta.href || '#'} className="inline-flex items-center gap-2 rounded-full border border-[var(--token-btn-secondary-border,var(--token-card-border))] bg-[var(--token-btn-secondary-bg,transparent)] px-6 py-3 text-sm font-bold text-[color:var(--token-btn-secondary-text,var(--token-on-dark-heading,var(--token-heading)))] backdrop-blur" data-edit-path="label">{secondaryCta.label}</a>}
          </div>
        </div>
        {facts.length > 0 && (
