        ...
        {cards.map((card, i) => {
          ...
          const body = (
            ...
            >
              ...
              {card.image && <img data-edit-image="image" src={card.image} alt="" className="absolute inset-0 h-full w-full object-cover opacity-35 transition duration-500 md:opacity-28 md:group-hover:opacity-36" />}
