  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
      <div>
        ...
        {cta.label && <a href={cta.href || '#'} className="mt-7 inline-flex items-center gap-2 rounded-full bg-[var(--token-btn-bg, var(--brand-btn-bg,var(--brand-primary,#111)))] px-5 py-3 text-sm font-bold text-[var(--token-btn-text, var(--brand-btn-text,#fff))]">{cta.label}<ArrowRight size={16} /></a>}
      </div>
