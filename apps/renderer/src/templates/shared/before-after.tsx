    ...
    <div ref={ref}>
      {(headline || description) && (
        <div className="text-center mb-10">
          {headline && <h2 className="font-display text-3xl md:text-4xl font-[var(--token-heading-weight,700)] tracking-[var(--token-heading-tracking,-0.02em)] text-[color:var(--token-heading)]" data-edit-path="headline">{headline}</h2>}
