      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px] md:auto-rows-[240px]">
        {displayLarge.map((item, i) => (
          <motion.a
            ...
            className="relative col-span-2 row-span-2 rounded-[var(--style-card-radius,1rem)] overflow-hidden group ring-2 ring-transparent hover:ring-[var(--brand-primary,var(--style-brand,#2563eb))] transition-all duration-300"
          >
            {item.image ? (
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 flex items-center gap-3">
              <span className="w-1 h-6 rounded-full bg-[var(--brand-primary,var(--style-brand,#2563eb))]" />
        ...
        {displaySmall.map((item, i) => (
          <motion.a
            ...
            className="relative col-span-1 row-span-1 rounded-[var(--style-card-radius,1rem)] overflow-hidden group ring-2 ring-transparent hover:ring-[var(--brand-primary,var(--style-brand,#2563eb))] transition-all duration-300"
          >
            {item.image ? (
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 flex items-center gap-2">
              <span className="w-0.5 h-4 rounded-full bg-[var(--brand-primary,var(--style-brand,#2563eb))]" />
