      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px] md:auto-rows-[240px]">
        {displayLarge.map((item, i) => (
          <motion.a
            ...
            className="relative col-span-2 row-span-2 rounded-[var(--style-card-radius,1rem)] overflow-hidden group"
          >
            {item.image ? (
        ...
        {displaySmall.map((item, i) => (
          <motion.a
            ...
            className="relative col-span-1 row-span-1 rounded-[var(--style-card-radius,1rem)] overflow-hidden group"
          >
            {item.image ? (
