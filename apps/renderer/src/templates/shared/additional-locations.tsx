              ...
              >
                ...
                <div className="p-6">
                  <div className="mb-5 flex items-start gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[var(--token-badge-bg)] text-[var(--token-icon)]">
                      <MapPin size={22} />
                    </div>
                    <div>
                      {location.name && <h3 className="text-xl font-black leading-tight text-[var(--token-heading)]" data-edit-path="name">{location.name}</h3>}
                  ...
                  <div className="space-y-3 text-sm">
                    {location.openingHours && (
                      <div className="flex gap-3 text-[var(--token-body)]">
