...
export function OfferCampaignStripSection({ data }: Props) {
  ...
  return (
    <section className="bg-[var(--token-section-bg)] px-4 py-8 text-[var(--token-body)]">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-3xl border border-[var(--token-card-border)] bg-[var(--token-card-bg)] shadow-2xl">
        <div className="grid md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="p-6 md:p-10">
            ...
            {headline && <h2 className="text-3xl font-black leading-tight text-[var(--token-heading)] md:text-5xl" data-edit-path="headline">{headline}</h2>}
