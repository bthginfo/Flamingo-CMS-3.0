...
const SHARED_SECTION_TYPES: SectionTypeDefinition[] = [
  ...
  { type: 'richText', label: 'Textblock', description: 'Formatierter Text für Impressum, Datenschutz etc.', category: 'Inhalt' },
  ...
  { type: 'kineticIdentity', label: 'Kinetic Identity', description: 'Morphende Markenaussagen mit synchroner Bildbühne', category: 'Advanced', setupLevel: 'guided', setupHint: 'Empfohlen: 3–6 kurze Aussagen, optional mit je einem Bild.', serviceAvailable: true },
  { type: 'signaturePath', label: 'Signature Path', description: 'Eine gezeichnete Markenlinie verbindet Inhalt und Prozess', category: 'Advanced', setupLevel: 'guided', setupHint: 'Benötigt 3–7 klar geordnete Stationen; der Pfad wird automatisch erzeugt.', serviceAvailable: true },
  { type: 'layeredAnatomy', label: 'Layered Anatomy', description: 'Hotspots oder explodierte Bildebenen erklären Details', category: 'Advanced', setupLevel: 'specialist', setupHint: 'Standard: ein Bild mit Hotspots. Pro: deckungsgleiche transparente Ebenen.', serviceAvailable: true },
  { type: 'guidedChoice', label: 'Guided Choice', description: 'Geführte Fragen führen zu einer passenden Empfehlung', category: 'Advanced', setupLevel: 'guided', setupHint: 'Score-Modus ist einfach; Branch-Modus benötigt vollständige Zielverknüpfungen.', serviceAvailable: true },
  { type: 'dayToNight', label: 'Day to Night', description: 'Ein Zeitregler wechselt zwischen atmosphärischen Szenen', category: 'Advanced', setupLevel: 'guided', setupHint: 'Benötigt 2–4 Szenen oder ein wiederholtes Bild mit unterschiedlichen Tints.', serviceAvailable: true },
  { type: 'livingBlueprint', label: 'Living Blueprint', description: 'Automatisch verbundene Knoten bilden einen lebenden Bauplan', category: 'Advanced', setupLevel: 'guided', setupHint: 'Benötigt 3–8 geordnete Knoten; Koordinaten und Verbindungen entstehen automatisch.', serviceAvailable: true },
  { type: 'editorialCardMorph', label: 'Editorial Card Morph', description: 'Visuelle Karten öffnen sich zu einer großen Editorial-Bühne', category: 'Advanced', setupLevel: 'guided', setupHint: 'Empfohlen: 3–8 Cases oder Leistungen mit starken Bildern und kurzen Texten.', serviceAvailable: true },
  { type: 'materialAtelier', label: 'Material Atelier', description: 'Große Bildbühne mit präzisem, indexiertem Material- oder Leistungsledger', category: 'Advanced', setupLevel: 'guided', setupHint: 'Empfohlen: 3–8 Positionen mit starkem Bild, kurzem Titel und optionalen Meta-Angaben.', serviceAvailable: true },
];
...
export const TRADESMAN_SECTION_TYPES: SectionTypeDefinition[] = [
  ...
  { type: 'richText', label: 'Textblock', description: 'Formatierter Text für Impressum, Datenschutz etc.' },
...
export const ECOMMERCE_SECTION_TYPES: SectionTypeDefinition[] = [
  ...
  { type: 'richText', label: 'Textblock', description: 'Formatierter Text für AGB, Widerruf etc.' },
