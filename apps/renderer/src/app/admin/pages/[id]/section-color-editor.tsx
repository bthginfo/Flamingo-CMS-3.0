...
const SECTION_FIELDS: Record<string, ColorFieldKey[]> = {
  ...
  materialGallery:   ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'accentColor', 'badgeBg', 'badgeText', 'borderColor'],
  deliveryTimeline:  ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'iconColor', 'accentColor', 'dividerColor'],
  inspirationGrid:   ['sectionBg', 'headingColor', 'subheadingColor', 'bodyColor', 'accentColor', 'badgeBg', 'badgeText'],
  ...
  locationPackages:  ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'accentColor', 'btnBg', 'btnText', 'borderColor', 'badgeBg', 'badgeText'],
  amenitiesGrid:     ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'accentColor', 'borderColor'],
  floorPlanOverview: ['sectionBg', 'headingColor', 'subheadingColor', 'bodyColor', 'btnBg', 'btnText', 'badgeBg', 'badgeText'],
  galleryMoodboard:  ['sectionBg', 'headingColor', 'subheadingColor', 'badgeBg', 'badgeText'],
  locationAccess:    ['sectionBg', 'headingColor'],
  hostTeam:          ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'accentColor', 'btnBg', 'btnText', 'borderColor', 'badgeBg', 'badgeText'],
};
