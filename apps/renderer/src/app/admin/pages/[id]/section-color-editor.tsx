...
const SECTION_FIELDS: Record<string, ColorFieldKey[]> = {
  ...
  cinematicHero: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'accentColor', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'badgeBorder', 'borderColor', 'textPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted'],
  ...
  ctaBand: ['sectionBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'onDarkHeading', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'badgeBorder', 'borderColor'],
  ...
  emergencyInfo: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'iconColor', 'accentColor', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor', 'textPrimary', 'textSecondary'],
  ...
  fitnessHero: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'statValue', 'btnBg', 'btnText', 'badgeText', 'borderColor'],
  floorPlanOverview: ['sectionBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary'],
  ...
  horizontalScrollShowcase: ['iconColor', 'brandPrimary'],
  ...
  locationHero: ['sectionBg', 'accentColor', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'badgeBorder', 'onDarkHeading', 'onDarkBody', 'onDarkMuted'],
  ...
  noticeBanner: ['iconColor', 'brandPrimary', 'onDarkHeading'],
  ...
  offerCampaignStrip: ['accentColor', 'brandPrimary'],
  ...
  portfolio: ['sectionBg', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'imageOverlay', 'borderColor'],
  ...
  proofWall: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'iconColor', 'quoteMark', 'ratingStar', 'statValue', 'accentColor', 'badgeBg', 'borderColor', 'brandPrimary'],
  ...
  seasonalCampaign: ['accentColor', 'brandPrimary'],
  serviceDetail: ['sectionBgAlt', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'brandAccent', 'eyebrow'],
  ...
  socialProofBar: ['accentColor', 'textPrimary', 'textSecondary', 'colorPrimary'],
  ...
  story: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'btnBg', 'btnText', 'badgeBg', 'borderColor'],
  ...
  testimonials: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'btnBg', 'badgeBg', 'badgeText', 'borderColor'],
