...
const SECTION_FIELDS: Record<string, ColorFieldKey[]> = {
  ...
  availabilityCta: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  beforeAfter: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'btnBg', 'badgeBg', 'borderColor', 'cardRadius', 'cardShadow', 'headingWeight', 'headingTracking'],
  ...
  beforeAfterStoryPro: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'statValue', 'check', 'btnBg', 'btnText', 'borderColor'],
  bentoGrid: ['cardBg', 'headingColor', 'bodyColor', 'iconColor', 'borderColor', 'textPrimary', 'textSecondary', 'colorPrimary'],
  bouquetShowcase: ['sectionBg', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'cardBorder', 'cardRadius', 'cardShadow', 'headingWeight', 'headingTracking'],
  brandShowroom: ['cardBg', 'subheadingColor', 'textPrimary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'borderColor', 'cardRadius', 'buttonRadius'],
  categoryMosaic: ['sectionBg', 'textPrimary', 'textSecondary', 'iconColor', 'styleBrand', 'brandPrimary', 'onDarkHeading', 'cardRadius', 'headingWeight', 'headingTracking'],
  ...
  collectionHero: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'badgeBg', 'badgeText', 'borderColor'],
  collectionList: ['cardBg', 'bodyColor', 'mutedColor', 'textSecondary', 'styleBrand', 'borderColor'],
  comparisonCardsPro: ['cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'check', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  comparisonTable: ['headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'accentColor', 'colorPrimary', 'borderColor'],
  consultationBooking: ['sectionBg', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'cardRadius', 'cardShadow', 'buttonRadius', 'headingWeight', 'headingTracking'],
  ...
  ctaBand: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'badgeBorder', 'borderColor'],
  ...
  embed: ['mutedColor', 'iconColor', 'brandPrimary'],
  eventTypes: ['sectionBg', 'textPrimary', 'textSecondary', 'iconColor', 'styleBrand', 'brandPrimary', 'onDarkHeading', 'cardRadius', 'headingWeight', 'headingTracking'],
  ...
  faq: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  featureShowcase: ['sectionBg', 'textPrimary', 'textSecondary', 'colorPrimary'],
  fitnessHero: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeText', 'borderColor'],
  floorPlanOverview: ['sectionBg', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'btnBg', 'btnText', 'borderColor'],
  floristHero: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeText', 'borderColor'],
  floristMaterials: ['sectionBg', 'sectionBgAlt', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'borderColor', 'cardRadius', 'headingWeight', 'headingTracking'],
  freeText: ['iconColor', 'accentColor', 'brandPrimary'],
  galleryGrid: ['sectionBg', 'sectionBgAlt', 'textPrimary', 'onDarkHeading'],
  galleryMoodboard: ['sectionBg', 'sectionBgAlt', 'textPrimary', 'onDarkHeading'],
  glowHero: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeText', 'borderColor'],
  headerBanner: ['sectionBg', 'sectionBgAlt', 'textPrimary', 'accentColor', 'onDarkHeading', 'onDarkBody', 'onDarkMuted'],
  ...
  heroEcommerce: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'accentColor', 'brandAccent', 'eyebrow', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'badgeBg', 'borderColor'],
  heroHandwerk: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'accentColor', 'brandAccent', 'eyebrow', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'badgeBg', 'borderColor'],
  horizontalScrollShowcase: ['sectionBg', 'bodyColor', 'iconColor', 'brandPrimary'],
  hostTeam: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'badgeBg', 'badgeText', 'borderColor'],
  immersiveCtaBanner: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  inspirationGrid: ['sectionBg', 'sectionBgAlt', 'textPrimary', 'textSecondary', 'iconColor', 'styleBrand', 'brandPrimary', 'onDarkHeading', 'cardRadius', 'headingWeight', 'headingTracking'],
  legalContent: ['textPrimary', 'iconColor', 'accentColor', 'brandPrimary'],
  locationAccess: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'textSecondary', 'borderColor'],
  ...
  locationPackages: ['cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'check', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  logoCloud: ['textSecondary'],
  logoMarquee: ['sectionBg', 'bodyColor', 'mutedColor'],
  map: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'textSecondary', 'borderColor'],
  ...
  materialGallery: ['sectionBg', 'sectionBgAlt', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'borderColor', 'cardRadius', 'headingWeight', 'headingTracking'],
  membershipPlans: ['cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'check', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  ...
  noticeBanner: ['iconColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted'],
  occasionMosaic: ['sectionBg', 'textPrimary', 'textSecondary', 'iconColor', 'styleBrand', 'brandPrimary', 'onDarkHeading', 'cardRadius', 'headingWeight', 'headingTracking'],
  ...
  openingHours: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  popup: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'borderColor', 'cardRadius', 'buttonRadius'],
  ...
  portfolio: ['sectionBg', 'sectionBgAlt', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'imageOverlay', 'borderColor'],
  premiumComparison: ['cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'iconColor', 'brandPrimary', 'borderColor', 'cardRadius'],
  principlesGrid: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'badgeBorder', 'borderColor'],
  processSteps: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'badgeBg', 'badgeText', 'borderColor'],
  productShowcase: ['sectionBg', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'cardBorder', 'cardRadius', 'cardShadow', 'headingWeight', 'headingTracking'],
  programGrid: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  ...
  richText: ['iconColor', 'accentColor', 'brandPrimary'],
  scrollStory: ['cardBg', 'headingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'borderColor', 'cardRadius'],
  ...
  serviceDetail: ['sectionBg', 'sectionBgAlt', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'borderColor'],
  ...
  servicesGrid: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  shopCart: ['sectionBg', 'sectionBgAlt', 'cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'accentColor', 'onDarkHeading', 'borderColor'],
  shopCategoryOverview: ['sectionBgAlt', 'cardBg', 'bodyColor', 'mutedColor', 'textSecondary', 'borderColor'],
  shopCheckout: ['sectionBg', 'sectionBgAlt', 'cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'borderColor'],
  shopFeaturedProducts: ['sectionBg', 'mutedColor', 'borderColor'],
  shopProductDetail: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'accentColor', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'borderColor'],
  shopProductGrid: ['sectionBg', 'sectionBgAlt', 'cardBg', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'borderColor'],
  shopThankYou: ['sectionBg', 'accentColor', 'textPrimary', 'textSecondary'],
  signatureGrid: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'imageTextColor', 'iconColor', 'accentColor', 'brandPrimary', 'statValue', 'badgeText', 'borderColor'],
  ...
  spaceShowcase: ['sectionBg', 'cardBg', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'cardBorder', 'cardRadius', 'cardShadow', 'headingWeight', 'headingTracking'],
  spotlightCards: ['cardBg', 'headingColor', 'bodyColor', 'iconColor', 'borderColor', 'cardRadius', 'textPrimary', 'textSecondary', 'brandPrimary'],
  stats: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'statValue', 'borderColor'],
  statsCounter: ['sectionBg', 'sectionBgAlt', 'headingColor', 'bodyColor', 'textPrimary', 'textSecondary', 'accentColor', 'colorPrimary', 'badgeBg', 'badgeText'],
  story: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeBg', 'borderColor'],
  studioAmenities: ['cardBg', 'headingColor', 'bodyColor', 'iconColor', 'borderColor', 'textPrimary', 'textSecondary', 'colorPrimary'],
  team: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'badgeBg', 'badgeText', 'borderColor'],
  ...
  testimonials: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'badgeBg', 'badgeText', 'borderColor'],
  textImage: ['sectionBg', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'btnBg', 'btnText', 'borderColor'],
  ...
  trainerProfiles: ['sectionBg', 'sectionBgAlt', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'accentColor', 'brandPrimary', 'brandAccent', 'eyebrow', 'badgeBg', 'badgeText', 'borderColor'],
  transformationStories: ['sectionBg', 'cardBg', 'headingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'eyebrow', 'btnBg', 'btnText', 'borderColor'],
  trialSessionCta: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'iconColor', 'accentColor', 'brandPrimary', 'statValue', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'btnBg', 'btnText', 'badgeBg', 'badgeText', 'borderColor'],
  uspStrip: ['sectionBgAlt', 'cardBg', 'textPrimary', 'textSecondary', 'accentColor', 'brandPrimary', 'borderColor'],
  ...
  verticalTimeline: ['sectionBg', 'cardBg', 'headingColor', 'subheadingColor', 'bodyColor', 'mutedColor', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'dividerColor'],
  videoEmbed: ['mutedColor'],
  weddingFloristry: ['cardBg', 'subheadingColor', 'textPrimary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'borderColor', 'cardRadius', 'buttonRadius'],
  workshopBooking: ['sectionBg', 'cardBg', 'textPrimary', 'textSecondary', 'iconColor', 'brandPrimary', 'onDarkHeading', 'onDarkBody', 'onDarkMuted', 'cardRadius', 'cardShadow', 'buttonRadius', 'headingWeight', 'headingTracking'],
};
