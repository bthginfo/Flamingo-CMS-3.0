...
function PracticeAreasEditor({ data, onChange }: EditorProps) {
  ...
  return <div className="space-y-3"><Field label="Badge" value={d.badgeText} onChange={v => setD({ ...d, badgeText: v })} /><Field label="Headline" value={d.headline} onChange={v => setD({ ...d, headline: v })} /><Field label="Subline" value={d.subline} onChange={v => setD({ ...d, subline: v })} multiline /><Repeater items={d.areas} addLabel="+ Rechtsgebiet" onAdd={() => setD({ ...d, areas: [...d.areas, { title: '', text: '', icon: '', href: '' }] })} render={(item, i) => <div className="space-y-2"><div className="grid grid-cols-2 gap-2"><Field label="Titel" value={item.title} onChange={v => updateItem(d, setD, 'areas', i, { ...item, title: v })} /><IconPickerField label="Icon" value={item.icon} onChange={v => updateItem(d, setD, 'areas', i, { ...item, icon: v })} /></div><Field label="Beschreibung" value={item.text} onChange={v => updateItem(d, setD, 'areas', i, { ...item, text: v })} multiline /><Field label="Detail-Link" value={item.href} onChange={v => updateItem(d, setD, 'areas', i, { ...item, href: v })} /></div>} /></div>;
}
...
function CaseResultsEditor({ data, onChange }: EditorProps) {
  ...
  return <div className="space-y-3"><Field label="Headline" value={d.headline} onChange={v => setD({ ...d, headline: v })} /><Field label="Subline" value={d.subline} onChange={v => setD({ ...d, subline: v })} multiline /><Repeater items={d.stats} addLabel="+ Statistik" onAdd={() => setD({ ...d, stats: [...d.stats, { value: '', suffix: '', prefix: '', label: '', icon: '' }] })} render={(item, i) => <div className="space-y-2"><div className="grid grid-cols-3 gap-2"><Field label="Prefix" value={item.prefix} onChange={v => updateItem(d, setD, 'stats', i, { ...item, prefix: v })} /><Field label="Wert (Zahl)" value={item.value} onChange={v => updateItem(d, setD, 'stats', i, { ...item, value: v })} /><Field label="Suffix" value={item.suffix} onChange={v => updateItem(d, setD, 'stats', i, { ...item, suffix: v })} /></div><div className="grid grid-cols-2 gap-2"><Field label="Label" value={item.label} onChange={v => updateItem(d, setD, 'stats', i, { ...item, label: v })} /><IconPickerField label="Icon" value={item.icon} onChange={v => updateItem(d, setD, 'stats', i, { ...item, icon: v })} /></div></div>} /></div>;
}
...
function FeeTableEditor({ data, onChange }: EditorProps) {
  ...
  useReport(d, onChange);
  return <div className="space-y-3"><Field label="Badge" value={d.badgeText} onChange={v => setD({ ...d, badgeText: v })} /><Field label="Headline" value={d.headline} onChange={v => setD({ ...d, headline: v })} /><Field label="Subline" value={d.subline} onChange={v => setD({ ...d, subline: v })} /><Repeater items={d.fees} addLabel="+ Position" onAdd={() => setD({ ...d, fees: [...d.fees, { title: '', price: '', description: '', icon: '', highlighted: false }] })} render={(item, i) => <div className="space-y-2"><div className="grid grid-cols-2 gap-2"><Field label="Titel" value={item.title} onChange={v => updateItem(d, setD, 'fees', i, { ...item, title: v })} /><Field label="Preis" value={item.price} onChange={v => updateItem(d, setD, 'fees', i, { ...item, price: v })} /></div><Field label="Beschreibung" value={item.description} onChange={v => updateItem(d, setD, 'fees', i, { ...item, description: v })} /><div className="grid grid-cols-2 gap-2"><IconPickerField label="Icon" value={item.icon} onChange={v => updateItem(d, setD, 'fees', i, { ...item, icon: v })} /><label className="flex items-center gap-2 text-xs mt-auto"><input type="checkbox" checked={item.highlighted} onChange={e => updateItem(d, setD, 'fees', i, { ...item, highlighted: e.target.checked })} /> Hervorgehoben</label></div></div>} /><Field label="Fußnote" value={d.footnote} onChange={v => setD({ ...d, footnote: v })} multiline /></div>;
}
...
function PublicationsEditor({ data, onChange }: EditorProps) {
  ...
  useReport(d, onChange);
  return <div className="space-y-3"><Field label="Badge" value={d.badgeText} onChange={v => setD({ ...d, badgeText: v })} /><Field label="Headline" value={d.headline} onChange={v => setD({ ...d, headline: v })} /><Field label="Subline" value={d.subline} onChange={v => setD({ ...d, subline: v })} /><Repeater items={d.articles} addLabel="+ Artikel" onAdd={() => setD({ ...d, articles: [...d.articles, { title: '', excerpt: '', date: '', category: '', href: '', image: '' }] })} render={(item, i) => <div className="space-y-2"><Field label="Titel" value={item.title} onChange={v => updateItem(d, setD, 'articles', i, { ...item, title: v })} /><Field label="Auszug" value={item.excerpt} onChange={v => updateItem(d, setD, 'articles', i, { ...item, excerpt: v })} multiline /><div className="grid grid-cols-2 gap-2"><Field label="Datum" value={item.date} onChange={v => updateItem(d, setD, 'articles', i, { ...item, date: v })} /><Field label="Kategorie" value={item.category} onChange={v => updateItem(d, setD, 'articles', i, { ...item, category: v })} /></div><ImageUploadField label="Bild" value={item.image} onChange={v => updateItem(d, setD, 'articles', i, { ...item, image: v })} /><Field label="Link" value={item.href} onChange={v => updateItem(d, setD, 'articles', i, { ...item, href: v })} /></div>} /><div className="grid grid-cols-2 gap-2"><Field label="CTA Label" value={d.ctaLabel} onChange={v => setD({ ...d, ctaLabel: v })} /><Field label="CTA Link" value={d.ctaHref} onChange={v => setD({ ...d, ctaHref: v })} /></div></div>;
}
