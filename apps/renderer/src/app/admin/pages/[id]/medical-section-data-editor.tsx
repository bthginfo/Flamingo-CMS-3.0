...
function ConfiguredField({ field, value, onChange }: { field: FieldConfig; value: unknown; onChange: (value: any) => void }) {
  ...
  if (field.kind === 'lines') return <LineListField label={field.label} value={str(value)} onChange={onChange} placeholder="Eintrag" addLabel="Eintrag hinzufügen" />;
  return <Field label={field.label} value={str(value)} onChange={onChange} multiline={field.kind === 'multiline'} />;
}
