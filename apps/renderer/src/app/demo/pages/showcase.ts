  ...
  pages: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          data: {
            content: '<h2>Verfügbare Sektionen</h2><p>Flamingo CMS bietet über 20 verschiedene Sektionstypen, die Sie frei kombinieren können. Jede Sektion ist responsiv, in mehreren Stilvarianten verfügbar und lässt sich vollständig mit Ihren Inhalten befüllen.</p><p>Klicken Sie auf die Kacheln unten, um jede Sektion in Aktion zu sehen — mit realistischen Beispielinhalten.</p>',
          },
        },
        {
          ...B, id: 'sc-grid', type: 'servicesGrid',
          data: {
            headline: 'Sektionstypen im Überblick',
            subline: 'Jede Kachel führt zu einer Detailseite mit Live-Vorschau der jeweiligen Sektion.',
            badgeText: 'Übersicht',
            manualCards: [
              ...
              { title: 'Bewertungen', text: 'Kundenstimmen mit Name, Kontext und Sternebewertung.', icon: 'star', mediaType: 'icon', href: '/demo/showcase/bewertungen' },
              ...
              { title: 'Team', text: 'Teamvorstellung mit Fotos, Rollen und Beschreibung.', icon: 'users', mediaType: 'icon', href: '/demo/showcase/team' },
              { title: 'Statistiken', text: 'Zahlen und Fakten in großer, animierter Darstellung.', icon: 'barChart', mediaType: 'icon', href: '/demo/showcase/statistiken' },
              { title: 'Logo-Cloud', text: 'Partnerlogos und Referenzen in einer Reihe.', icon: 'building', mediaType: 'icon', href: '/demo/showcase/logo-cloud' },
              { title: 'Rich Text', text: 'Freier Texteditor mit Überschriften, Listen und Formatierungen.', icon: 'fileText', mediaType: 'icon', href: '/demo/showcase/rich-text' },
              { title: 'Video-Embed', text: 'YouTube oder Vimeo-Video einbetten.', icon: 'play', mediaType: 'icon', href: '/demo/showcase/video' },
              { title: 'Hinweisbanner', text: 'Farbiger Hinweis-Banner mit optionalen Buttons.', icon: 'alertTriangle', mediaType: 'icon', href: '/demo/showcase/hinweisbanner' },
              { title: 'Header-Banner', text: 'Schmaler Banner mit Text über der Seite.', icon: 'type', mediaType: 'icon', href: '/demo/showcase/header-banner' },
            ],
          },
        },
      ],
