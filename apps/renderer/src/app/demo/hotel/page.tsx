...
const sections: SnapshotSection[] = [
  {
    ...
    data: {
      ...
      primaryCta: { label: 'Verfuegbarkeit pruefen', href: '#booking' },
  ...
  },
  {
    ...
    data: {
      ...
      guestsLabel: 'Gaeste',
      roomLabel: 'Zimmer',
      submitCta: { label: 'Jetzt pruefen', href: '#zimmer' },
      ...
      rooms: [
        {
          ...
          detailCta: { label: 'Details', href: '#booking' },
          bookingCta: { label: 'Buchen', href: '#booking' },
          highlighted: true,
        },
      ],
      ...
      offers: [
        {
          ...
          cta: { label: 'Anfragen', href: '#booking' },
          detailHref: '#booking',
          detailLabel: 'Details',
          highlighted: true,
        },
  ...
  },
  {
    ...
    data: {
      ...
      ctaPrimary: { label: 'Alle Services ansehen', href: '#booking' },
    },
  },
  {
    ...base,
    ...
    data: {
      ...
      treatments: [{ title: 'Aroma Massage', text: 'Ruhige Anwendung mit warmen Oelen.', durationLabel: '50 Minuten', priceLabel: '89', image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=800&q=80', cta: { label: 'Termin anfragen', href: '#booking' } }],
      features: [{ icon: 'heart', title: 'Ruheraum', text: 'Leise Zonen mit Blick ins Gruene.' }],
      ctaPrimary: { label: 'Spa anfragen', href: '#booking' },
    },
  },
  {
    ...base,
  ...
  },
  {
    ...
    data: {
      ...
      menus: [{ title: 'Fruehstueck', description: 'Buffet, Eierspeisen und Kaffee.', timeLabel: '7-11 Uhr', priceLabel: 'inklusive', cta: { label: 'Mehr erfahren', href: '#booking' } }],
      ...
      ctaPrimary: { label: 'Tisch anfragen', href: '#booking' },
    },
  },
  {
    ...base,
    ...
    data: {
      ...
      badgeText: 'Raeume',
      spaces: [{ name: 'Salon Linden', description: 'Heller Raum mit Zugang zur Terrasse.', image: 'https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=900&q=80', capacityLabel: 'bis 60 Personen', sizeLabel: '90 qm', seatingOptions: ['U-Form', 'Dinner', 'Theater'], features: ['Beamer', 'Terrasse', 'Bar'], inquiryCta: { label: 'Anfragen', href: '#booking' } }],
      processHeadline: 'So planen wir gemeinsam',
      processSteps: [{ icon: 'clipboard', title: 'Anfrage', text: 'Rahmen und Ziel klaeren.' }],
      ctaPrimary: { label: 'Event anfragen', href: '#booking' },
    },
  },
  {
    ...base,
    ...
    data: {
      ...
      ctaPrimary: { label: 'Aufenthalt planen', href: '#booking' },
    },
  },
  {
    ...base,
    id: 'hotel-testimonials',
    type: 'testimonials',
    data: {
      ...
      ctaPrimary: { label: 'Jetzt anfragen', href: '#booking' },
    },
  },
  {
    ...base,
...
export default function HotelDemoPage() {
  const styleCssVars = getStyleCssVars('hotel', 'classic');
  const { navItems, cta, brand, contact, socialLinks, footer } = getDemoSiteData('hotel');
  return (
    <div data-style="classic" style={styleCssVars as React.CSSProperties}>
      ...
      <main>{sections.map((section) => <SectionRenderer key={section.id} section={section} styleVariant="classic" industry="hotel" />)}</main>
