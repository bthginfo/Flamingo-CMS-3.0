...
export async function GET(req: NextRequest) {
  ...
  const response: Record<string, unknown> = {
    ...
    restrictions: [
      ...
      'Give every card or step a distinct substantive description. Copying the same paragraph under different titles fails plan validation.',
      'For each video reel, provide a representative poster from the same project; otherwise a blank first frame can appear before playback.',
...
function getStyleSystemInstructions() {
  return {
    ...
    contrastRules: [
      ...
      'Text inside image cards uses inverse light text independently from the surrounding section heading color. Keep a dark scrim behind every caption and inspect real image and video frames on desktop and mobile.',
