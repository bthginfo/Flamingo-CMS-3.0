...
export const SECTION_PREVIEW_DATA: Record<string, Record<string, unknown>> = {
  ...
  cameraExplodeScroll: {
    ...
    subline: 'Die Kamera zerlegt sich in die Arbeitsschritte, die aus Foto, Film und KI-Workflow verwertbare Marken-Assets machen.',
    parts: [
      { id: 'briefing', label: 'Briefing', text: 'Ziel, Zielgruppe und Einsatzkanäle geben der Produktion Richtung.', offsetX: -96, offsetY: -18, color: '#f4efe4' },
      { id: 'look', label: 'Bildsprache', text: 'Licht, Farbe, Perspektive und Setting werden als visuelle Linie geplant.', offsetX: 0, offsetY: -104, color: '#111111' },
      { id: 'production', label: 'Produktion', text: 'Foto, Film und Reels entstehen so, dass mehrere Kanäle bedient werden können.', offsetX: 105, offsetY: -12, color: '#d4142a' },
      { id: 'postproduction', label: 'Postproduktion', text: 'Auswahl, Retusche, Schnitt und Grading halten alles aus einem Guss.', offsetX: -82, offsetY: 88, color: '#ffffff' },
      { id: 'output', label: 'Assets', text: 'Fertige Formate für Website, Social, Kampagne, Recruiting und Print.', offsetX: 92, offsetY: 82, color: '#c7ff4a' },
    ],
  ...
  contactLocation: {
    headline: 'Standort & Anreise',
    subline: 'Alle wichtigen Wege, Kontakte und Ziele kompakt an einem Ort.',
    badgeText: 'Gut erreichbar',
    addressText: 'Seestraße 1, 83700 Rottach-Egern',
    phone: '+49 8022 123456',
    email: 'willkommen@beispiel.de',
    mapEmbedUrl: '',
    image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200&q=82',
    transportItems: [
      { icon: 'car', label: 'Mit dem Auto', value: '20 Min.', text: 'Ab der nächsten Autobahnausfahrt.' },
      { icon: 'train', label: 'Mit der Bahn', value: '55 Min.', text: 'Direkte Verbindung plus kurzer Transfer.' },
    ],
    nearbyItems: [
      { title: 'Ortszentrum', distanceLabel: '5 Minuten' },
      { title: 'Seeufer', distanceLabel: '8 Minuten' },
    ],
    routeCta: { label: 'Route planen', href: '#kontakt' },
  },
  hotelDining: {
  ...
  venueInfo: {
    ...
    subline: "",
    venues: [],
    contact: '+49 8022 123 456 · feiern@schloss-hohenstein.de',
    directions: "",
    sections: [],
    accommodations: [],
    hotels: [],
  ...
  smartInquiry: {
    badge: 'Projektbrief in 2 Minuten',
    headline: 'Aus einer Idee wird eine Anfrage, mit der wir direkt arbeiten können.',
    subline: 'Drei kurze Schritte ersetzen das leere Nachrichtenfeld und geben Ihnen sofort einen klaren nächsten Schritt.',
    trustNote: 'Persönliche Rückmeldung innerhalb eines Werktags · unverbindlich und vertraulich',
    goals: [
      { label: 'Etwas Neues starten', description: 'Ein neues Angebot, Projekt oder einen neuen Auftritt entwickeln.', icon: 'sparkles' },
      { label: 'Bestehendes verbessern', description: 'Qualität, Wirkung oder Ergebnisse eines bestehenden Angebots steigern.', icon: 'chart-no-axes-combined' },
      { label: 'Konkretes Problem lösen', description: 'Eine klar umrissene Herausforderung schnell und verlässlich angehen.', icon: 'target' },
      { label: 'Erst einmal orientieren', description: 'Optionen verstehen und den sinnvollsten nächsten Schritt finden.', icon: 'compass' },
    ],
    scopeLabel: 'Gewünschter Umfang',
    scopeOptions: [
      { label: 'Kompakter Einstieg', description: 'Ein klar abgegrenztes Ergebnis.' },
      { label: 'Umfassendes Projekt', description: 'Mehrere Bausteine greifen ineinander.' },
      { label: 'Noch offen', description: 'Den Umfang gemeinsam festlegen.' },
    ],
    timingLabel: 'Gewünschter Start',
    timingOptions: [
      { label: 'So bald wie möglich' },
      { label: 'In 1–3 Monaten' },
      { label: 'Später / noch offen' },
    ],
    ...
    fields: [
      ...
      { name: 'email', label: 'E-Mail', type: 'email', placeholder: 'name@unternehmen.de', required: true, halfWidth: true },
      { name: 'phone', label: 'Telefon', type: 'tel', placeholder: 'Optional für einen Rückruf' },
      { name: 'message', label: 'Was sollten wir noch wissen?', type: 'textarea', placeholder: 'Optional: Kontext, Wünsche oder offene Fragen' },
    ],
    nextLabel: 'Weiter',
    backLabel: 'Zurück',
    submitLabel: 'Anfrage mit Brief senden',
    summaryTitle: 'Ihr Projektbrief',
    summaryEmptyText: 'Ihre Auswahl erscheint hier Schritt für Schritt.',
  },
  offerMatcher: {
    badge: 'In zwei Minuten zum passenden Angebot',
    headline: 'Nicht irgendein Paket. Sondern der nächste Schritt, der zu Ihnen passt.',
    subline: 'Drei kurze Antworten genügen. Sie erhalten eine klare Empfehlung und können direkt mit einem vorbereiteten Briefing anfragen.',
    panelTitle: 'Ihr Angebotsprofil',
    panelHint: 'Mit jeder Antwort wird die Empfehlung präziser. Ihre Auswahl bleibt transparent und kann jederzeit geändert werden.',
    helperText: 'Wählen Sie spontan – jede Antwort kann vor dem Ergebnis noch geändert werden.',
    privacyText: 'Ihre Auswahl enthält keine persönlichen Daten und wird erst beim Wechsel zur Anfrage übergeben.',
    progressLabel: 'beantwortet',
    questionLabel: 'Frage',
    fallbackText: 'Der Angebots-Finder ist noch nicht vollständig eingerichtet. Eine persönliche Empfehlung erhalten Sie trotzdem direkt von uns.',
    fallbackCta: { label: 'Persönlich beraten lassen', href: '/kontakt' },
    nextLabel: 'Weiter',
    backLabel: 'Zurück',
    resultLabel: 'Empfehlung anzeigen',
    restartLabel: 'Neu starten',
    questions: [
      {
        id: 'goal',
        label: 'Was soll sich für Sie vor allem verändern?',
        description: 'Wählen Sie den Effekt, der für Sie gerade am wichtigsten ist.',
        options: [
          { id: 'clarity', label: 'Klarheit gewinnen', description: 'Möglichkeiten ordnen und den besten Einstieg finden.', icon: 'compass', matches: ['focus-session', 'growth-program'], tags: ['strategy'] },
          { id: 'launch', label: 'Schnell professionell starten', description: 'Mit einem klaren Angebot sichtbar und handlungsfähig werden.', icon: 'rocket', matches: ['launch-package'], tags: ['launch'] },
          { id: 'growth', label: 'Mehr passende Anfragen', description: 'Bestehende Stärken schärfen und die Conversion verbessern.', icon: 'chart-no-axes-combined', matches: ['growth-program'], tags: ['growth'] },
          { id: 'transform', label: 'Komplett neu aufstellen', description: 'Positionierung, Inhalte und Auftritt ganzheitlich weiterentwickeln.', icon: 'sparkles', matches: ['signature-project'], tags: ['transformation'] },
        ],
      },
      {
        id: 'collaboration',
        label: 'Wie viel Unterstützung wünschen Sie sich?',
        description: 'Von einer fundierten Richtung bis zur vollständigen Umsetzung.',
        options: [
          { id: 'direction', label: 'Eine klare Richtung', description: 'Ich möchte danach selbstständig weiterarbeiten.', icon: 'map', matches: ['focus-session'], tags: ['strategy'] },
          { id: 'together', label: 'Gemeinsam entwickeln', description: 'Entscheidungen treffen und Schritt für Schritt umsetzen.', icon: 'users', matches: ['growth-program', 'launch-package'], tags: ['growth', 'launch'] },
          { id: 'full-service', label: 'Komplett übernehmen lassen', description: 'Von der Strategie bis zum fertigen Ergebnis.', icon: 'wand-sparkles', matches: ['signature-project'], tags: ['transformation'] },
        ],
      },
      {
        id: 'timing',
        label: 'Wann soll das Ergebnis für Sie arbeiten?',
        description: 'Eine realistische Einordnung hilft bei der passenden Empfehlung.',
        options: [
          { id: 'explore', label: 'Ich orientiere mich noch', description: 'Noch kein fixer Starttermin.', icon: 'search', matches: ['focus-session'], tags: ['strategy'] },
          { id: 'soon', label: 'In den nächsten Wochen', description: 'Die wichtigsten Grundlagen stehen bereits.', icon: 'calendar-days', matches: ['launch-package', 'growth-program'], tags: ['launch', 'growth'] },
          { id: 'priority', label: 'So bald wie sinnvoll', description: 'Das Thema hat Priorität und darf umfassend gelöst werden.', icon: 'zap', matches: ['signature-project'], tags: ['transformation'] },
        ],
      },
    ],
    offers: [
      {
        ...
        title: 'Focus Session',
        description: 'Ein kompakter Strategietermin, der Optionen ordnet, Prioritäten sichtbar macht und einen belastbaren nächsten Schritt definiert.',
        reason: 'Ideal, wenn Sie zuerst Klarheit und eine fundierte Richtung brauchen, bevor Sie größer investieren.',
        priceLabel: 'Kompakter, planbarer Einstieg',
        features: ['90 Minuten mit klarer Vorbereitung', 'Priorisierte Handlungsempfehlungen', 'Konkreter Fahrplan im Nachgang'],
        tags: ['strategy'],
        priority: 1,
        fallback: true,
        primaryCta: { label: 'Focus Session anfragen', href: '#kontakt' },
        secondaryCta: { label: 'Leistungen ansehen', href: '#leistungen' },
      },
      {
        id: 'launch-package',
        eyebrow: 'Schnell startklar',
        title: 'Launch Package',
        description: 'Ein fokussiertes Umsetzungspaket für einen professionellen Start mit klarer Botschaft, starken Inhalten und sauberem Conversion-Pfad.',
        reason: 'Passt, wenn Sie zeitnah sichtbar werden wollen und die wichtigsten Entscheidungen bereits treffen können.',
        priceLabel: 'Fester Rahmen, klarer Zeitplan',
        features: ['Strategischer Kick-off', 'Fokussierte Umsetzung', 'Launch- und Qualitätscheck'],
        tags: ['launch'],
        priority: 2,
        primaryCta: { label: 'Launch besprechen', href: '#kontakt' },
      },
      {
        id: 'growth-program',
        eyebrow: 'Mehr Wirkung',
        title: 'Growth Program',
        description: 'Eine gemeinsame Optimierung für Angebot, Nutzerführung und Conversion, die auf vorhandenen Stärken aufbaut.',
        reason: 'Die richtige Wahl, wenn bereits eine Basis existiert und daraus systematisch mehr passende Nachfrage entstehen soll.',
        priceLabel: 'Modular und messbar',
        features: ['Conversion-Audit', 'Priorisierte Experimente', 'Begleitete Optimierungszyklen'],
        tags: ['growth'],
        priority: 3,
        primaryCta: { label: 'Wachstumspotenzial klären', href: '#kontakt' },
      },
      {
        id: 'signature-project',
        eyebrow: 'Ganzheitliche Lösung',
        title: 'Signature Project',
        description: 'Die umfassende Zusammenarbeit für eine neue Positionierung, ein konsistentes Erlebnis und eine hochwertige Umsetzung aus einem Guss.',
        reason: 'Empfohlen, wenn das Thema Priorität hat und Strategie, Inhalt sowie Umsetzung konsequent zusammenspielen sollen.',
        priceLabel: 'Individuell nach Umfang',
        features: ['Positionierung und Experience-Konzept', 'Komplette Umsetzung', 'Launch, Qualitätssicherung und Optimierung'],
        tags: ['transformation'],
        priority: 4,
        primaryCta: { label: 'Signature Project anfragen', href: '#kontakt' },
      },
    ],
  },
  mobileActionDock: {
    compactLabel: 'Direkt zum nächsten Schritt',
    revealAfterScroll: true,
    revealAfterPx: 220,
    desktopMode: 'inline',
    hideOnPaths: ['/checkout', '/warenkorb'],
    actions: [
  ...
  nextMatchHero: {
    ...
    headline: 'Kommt in die Halle!',
    competition: 'Oberliga Süd',
    dateLabel: 'Sa 12.10. · 19:30 Uhr',
    homeTeam: 'ERC Ingolstadt II',
    awayTeam: 'EV Landshut',
    homeLogo: '',
    awayLogo: '',
    venue: 'Saturn-Arena Ingolstadt',
    image: 'https://images.unsplash.com/photo-1607627000458-210e8d2bdb1d?auto=format&fit=crop&w=1600&q=80',
    primaryCta: { label: 'Tickets sichern', href: '#' },
    secondaryCta: { label: 'Zum Spielplan', href: '#' },
  },
  matchSchedule: {
    badgeText: 'Saison 2025/26',
    headline: 'Spielplan',
    subline: 'Alle Termine der Hauptrunde auf einen Blick.',
    matches: [
      { dateLabel: 'Sa 12.10.', competition: 'Oberliga', homeTeam: 'ERC Ingolstadt II', awayTeam: 'EV Landshut', venue: 'Saturn-Arena', homeGame: true, ticketHref: '/demo/eishockey/kontakt' },
      { dateLabel: 'Fr 18.10.', competition: 'Oberliga', homeTeam: 'Deggendorfer SC', awayTeam: 'ERC Ingolstadt II', venue: 'Deggendorf', homeGame: false },
      { dateLabel: 'So 20.10.', competition: 'Oberliga', homeTeam: 'ERC Ingolstadt II', awayTeam: 'Höchstadt Alligators', venue: 'Saturn-Arena', result: '4:2', homeGame: true },
      { dateLabel: 'Fr 25.10.', competition: 'Pokal', homeTeam: 'Selber Wölfe', awayTeam: 'ERC Ingolstadt II', venue: 'Selb', homeGame: false },
      { dateLabel: 'So 27.10.', competition: 'Oberliga', homeTeam: 'ERC Ingolstadt II', awayTeam: 'Memmingen Indians', venue: 'Saturn-Arena', homeGame: true, ticketHref: '/demo/eishockey/kontakt' },
    ],
  },
  leagueTable: {
    badgeText: 'Tabelle',
    ...
    rows: [
      ...
      { rank: '3', team: 'ERC Ingolstadt II', played: '8', won: '5', drawn: '1', lost: '2', points: '16', highlight: true },
  ...
  teamRoster: {
    ...
    subline: 'Torhüter, Verteidigung und Sturm.',
    players: [
      { number: '1', name: 'Max Berger', position: 'Torwart', nationality: 'DE', image: 'https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=500&q=80' },
      { number: '7', name: 'Jonas Weiß', position: 'Verteidigung', nationality: 'DE', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=500&q=80' },
      { number: '12', name: 'Elias Novák', position: 'Verteidigung', nationality: 'CZ', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80' },
      { number: '19', name: 'Lukas Fischer', position: 'Center', nationality: 'DE', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=500&q=80' },
      { number: '23', name: 'Ryan O’Connor', position: 'Flügel', nationality: 'CA', image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=500&q=80' },
    ],
  },
  sponsorsWall: {
    badgeText: 'Danke',
    headline: 'Unsere Partner',
    subline: 'Gemeinsam für den Nachwuchs und den Sport in der Region.',
    tiers: [
      { tierLabel: 'Hauptsponsoren', logos: [ { name: 'Saturn' }, { name: 'Audi' }, { name: 'Stadtwerke' } ] },
      { tierLabel: 'Premium-Partner', logos: [ { name: 'Sparkasse' }, { name: 'Media Markt' }, { name: 'Bauhaus' }, { name: 'Getränke Huber' } ] },
      { tierLabel: 'Förderpartner', logos: [ { name: 'Bäckerei Müller' }, { name: 'Autohaus Weber' }, { name: 'Physio Aktiv' }, { name: 'Pizzeria Roma' }, { name: 'Optik Klar' } ] },
    ],
  },
};
