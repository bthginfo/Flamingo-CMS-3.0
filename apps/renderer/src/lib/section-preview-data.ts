...
export const SECTION_PREVIEW_DATA: Record<string, Record<string, unknown>> = {
  ...
  menuCard: {
    ...
    subline: 'Frische Zutaten, saisonale Gerichte – t\u00e4glich frisch zubereitet',
    badgeText: 'Saisonal',
    categories: [
      {
        label: 'Vorspeisen',
        items: [
          { title: 'Bruschetta Classica', description: 'Ger\u00f6stetes Ciabatta mit Tomaten, Basilikum & Knoblauch', price: '8,90 \u20ac', badge: 'Beliebt' },
          { title: 'Burrata auf Rucola', description: 'Cremige Burrata, Rucola, Kirschtomaten, Pinienkerne', price: '12,50 \u20ac' },
          { title: 'Tagessuppe', description: 'Frisch zubereitet \u2013 bitte fragen Sie unser Team', price: '6,90 \u20ac' },
        ],
      },
      {
        label: 'Hauptgerichte',
        items: [
          { title: 'Wiener Schnitzel', description: 'Vom Kalb, mit Kartoffelsalat und Preiselbeeren', price: '24,90 \u20ac', badge: 'Empfehlung' },
          { title: 'Pasta Aglio e Olio', description: 'Spaghetti mit Knoblauch, Chili, Oliven\u00f6l & Parmesan', price: '14,90 \u20ac' },
          { title: 'Gegrillter Lachs', description: 'Mit Zitronenbutter, Spargel und Kartoffelp\u00fcree', price: '22,50 \u20ac' },
        ],
      },
      {
        label: 'Desserts',
        items: [
          { title: 'Panna Cotta', description: 'Mit frischen Beeren und Minze', price: '7,90 \u20ac' },
          { title: 'Tiramisu', description: 'Hauseigene Rezeptur mit Amaretto', price: '8,50 \u20ac' },
        ],
      },
    ],
  },
  ...
  ctaSplit: {
    badge: 'Jetzt starten',
    headline: 'In 14 Tagen online — ohne dass Sie Technik anfassen müssen.',
    text: '<p>Wir übernehmen Struktur, Texte, Bilder und Einrichtung. Sie prüfen, geben frei — und pflegen danach alles selbst im CMS.</p>',
    image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=82',
    checklist: ['Festpreis ohne Überraschungen', 'Persönlicher Ansprechpartner', 'Inhalte selbst pflegbar', 'DSGVO-konformes Hosting'],
    primaryCta: { label: 'Projekt anfragen', href: '#kontakt' },
    secondaryCta: { label: 'Beispiele ansehen', href: '#referenzen' },
    note: 'Unverbindliches Erstgespräch — Antwort innerhalb von 24 Stunden.',
  },
  openingStatus: {
    badge: 'Öffnungszeiten',
    headline: 'Wann Sie uns erreichen',
    subline: 'Der Status aktualisiert sich automatisch — Ihre Kunden sehen sofort, ob gerade geöffnet ist.',
    days: [
      { day: 'Montag', hours: '09:00 – 18:00' },
      { day: 'Dienstag', hours: '09:00 – 18:00' },
      { day: 'Mittwoch', hours: '09:00 – 13:00', note: 'nachmittags Termine' },
  ...
  teamSpotlight: {
    ...
    subline: 'Beim Überfahren der Karten zeigen sich Zitat, Schwerpunkte und Kontaktwege.',
    members: [
      { name: 'Sarah Winkler', role: 'Gründerin & Strategie', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&q=82', quote: 'Gute Arbeit erkennt man daran, dass sie leise überzeugt.', focus: ['Strategie', 'Beratung'], linkedin: 'https://linkedin.com' },
      { name: 'Jonas Berger', role: 'Kreation', image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=800&q=82', quote: 'Design ist entschieden, nicht dekoriert.', focus: ['Design', 'Marke'], instagram: 'https://instagram.com' },
      { name: 'Mia Kraus', role: 'Projektleitung', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=800&q=82', quote: 'Termine hält man, indem man ehrlich plant.', focus: ['Projekte', 'Kundenkontakt'], email: 'mia@example.com' },
    ],
  },
  faqContactSplit: {
    badge: 'FAQ',
    headline: 'Häufige Fragen — und ein direkter Draht.',
    subline: 'Das Akkordeon beantwortet die Standardfragen, die Kontaktkarte fängt alles andere auf.',
    items: [
      { question: 'Wie lange dauert ein Projekt?', answer: 'Vom Kickoff bis zum Launch meist zwei bis vier Wochen — abhängig davon, wie schnell Inhalte freigegeben werden.' },
      { question: 'Was kostet die laufende Betreuung?', answer: 'Die Basis-Betreuung mit Hosting, Updates und Support ist im Monatspreis enthalten. Erweiterungen kalkulieren wir transparent vorab.' },
      { question: 'Kann ich Inhalte selbst ändern?', answer: 'Ja — genau dafür ist das CMS gebaut. Texte, Bilder, Farben und ganze Sektionen pflegen Sie ohne Technikkenntnisse.' },
      { question: 'Was passiert mit meiner alten Website?', answer: 'Wir übernehmen Inhalte, richten Weiterleitungen ein und sorgen dafür, dass Google-Rankings erhalten bleiben.' },
    ],
    contactTitle: 'Ihre Frage ist nicht dabei?',
    contactText: 'Schreiben Sie uns — wir antworten meist innerhalb eines Werktags.',
    phone: '+49 89 1234567',
  ...
  galleryPro: {
    ...
    subline: 'Filterbar nach Kategorie, mit Lightbox und Tastatur-Navigation.',
    images: [
      { src: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=900&q=82', alt: 'Modernes Wohnhaus', category: 'Neubau', caption: 'Stadthaus am Park' },
      { src: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=900&q=82', alt: 'Offene Küche', category: 'Innenausbau', caption: 'Küche mit Kochinsel' },
      { src: 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&w=900&q=82', alt: 'Badezimmer', category: 'Sanierung', caption: 'Bad in Naturstein' },
      { src: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=900&q=82', alt: 'Wohnzimmer', category: 'Innenausbau', caption: 'Wohnbereich mit Kamin' },
      { src: 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?auto=format&fit=crop&w=900&q=82', alt: 'Fassade', category: 'Neubau', caption: 'Klinker-Fassade' },
