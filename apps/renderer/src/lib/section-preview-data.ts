...
export const SECTION_PREVIEW_DATA: Record<string, Record<string, unknown>> = {
  ...
  nextMatchHero: {
    ...
    homeLogo: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=200&q=80',
    awayLogo: 'https://images.unsplash.com/photo-1543357480-c60d40007a3f?auto=format&fit=crop&w=200&q=80',
    venue: 'Saturn-Arena Ingolstadt',
    image: 'https://images.unsplash.com/photo-1580692475446-c2fabbbe4c46?auto=format&fit=crop&w=1600&q=80',
  ...
  matchSchedule: {
    ...
    matches: [
      { dateLabel: 'Sa 12.10.', competition: 'Oberliga', homeTeam: 'ERC Ingolstadt II', awayTeam: 'EV Landshut', venue: 'Saturn-Arena', homeGame: true, ticketHref: '#' },
      ...
      { dateLabel: 'So 27.10.', competition: 'Oberliga', homeTeam: 'ERC Ingolstadt II', awayTeam: 'Memmingen Indians', venue: 'Saturn-Arena', homeGame: true, ticketHref: '#' },
    ],
  },
  leagueTable: {
    badgeText: 'Tabelle',
